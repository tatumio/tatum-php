...
use Tatum\Cryptography\Crypto\EcAdapter\Impl\Secp256k1\Serializer\Key\PublicKeySerializer;
...
class PublicKey extends Key implements PublicKeyInterface {
    ...
    private function doEquals(PublicKey $other): bool {
        ...
        if (
            !(
                secp256k1_ec_pubkey_serialize($context, $pubA, $this->pubkey_t, $flags) &&
                secp256k1_ec_pubkey_serialize($context, $pubB, $other->pubkey_t, $flags)
            )
        ) {
