...
use Tatum\Cryptography\Elliptic\EdDSA\KeyPair;
use Tatum\Cryptography\Elliptic\EdDSA\Signature;
use Tatum\Cryptography\Elliptic\Curves;
...
class EdDSA {
    ...
    function __construct($curve) {
        ...
        $curve = Curves::getCurve($curve)->curve;
        $this->curve = $curve;
        $this->g = $curve->g;
