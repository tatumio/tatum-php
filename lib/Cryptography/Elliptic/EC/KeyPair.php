...
namespace Tatum\Cryptography\Elliptic\EC;
...
class KeyPair {
    ...
    public function getPrivate($enc = false) {
        if ($enc === "hex") {
            return null !== $this->priv ? $this->priv->toString(16, 2) : "";
        }
    ...
    private function _importPrivate($key, $enc) {
        $this->priv = new BigNumber($key, isset($enc) && $enc ? $enc : 16);
    ...
    public function inspect() {
        return "<Key priv: " .
            (isset($this->priv) ? $this->priv->toString(16, 2) : "") .
            " pub: " .
            (isset($this->pub) ? $this->pub->inspect() : "") .
            ">";
    }
