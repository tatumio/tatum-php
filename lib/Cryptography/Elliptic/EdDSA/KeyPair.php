...
class KeyPair {
    ...
    /**
     * @param \Tatum\Cryptography\Elliptic\EdDSA $eddsa  Instance
     * @param Object                             $params Public/private key parameters
     * {Array<Byte>} [params.secret] - secret seed bytes
     * {Point} [params.pub] - public key point (aka `A` in eddsa terms)
     * {Array<Byte>} [params.pub] - public key point encoded as bytes
     */
