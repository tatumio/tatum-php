...
namespace Tatum\Cryptography\Elliptic\Curve\BaseCurve;
...
abstract class Point {
    ...
    abstract function getX(): BigNumber;
    abstract function getY(): BigNumber;
    abstract function add($point): Point;
    abstract function dbl(): Point;
    abstract function mixedAdd($points);
    ...
    protected function _hasDoubles($k) {
        ...
        return count($this->precomputed["doubles"]["points"]) >=
            ceil(($k->bitLength() + 1) / $this->precomputed["doubles"]["step"]);
    }
