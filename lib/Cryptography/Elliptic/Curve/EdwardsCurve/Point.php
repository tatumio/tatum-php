<?php
namespace Tatum\Cryptography\Elliptic\Curve\EdwardsCurve;
...
class Point extends BasePoint {
    ...
    function __construct($curve, $x = null, $y = null, $z = null, $t = null) {
        ...
        if ($x == null && $y == null && $z == null) {
            ...
            $this->z = $z ? new BigNumber($z, 16) : $this->curve->one;
            $this->t = $t ? new BigNumber($t, 16) : null;
            if (!$this->x->red) {
    ...
    public function add($p): BasePoint {
        if ($this->isInfinity()) {
            return $p;
        }
        if ($p->isInfinity()) {
    ...
    public function getX(): BigNumber {
        $this->normalize();
        return $this->x->fromRed();
    }

    public function getY(): BigNumber {
        $this->normalize();
