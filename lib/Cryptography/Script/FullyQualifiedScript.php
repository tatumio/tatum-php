...
use Tatum\Cryptography\Exceptions\MissingScriptException;
use Tatum\Cryptography\Exceptions\ScriptHashMismatch;
use Tatum\Cryptography\Exceptions\ScriptQualificationError;
use Tatum\Cryptography\Exceptions\SuperfluousScriptData;
...
use Tatum\Cryptography\Transaction\Factory\SigValues;
...
class FullyQualifiedScript {
     ...
     */
    public function __construct(OutputData $spkData, OutputData $rsData = null, OutputData $wsData = null) {
        $signScript = $spkData;
    ...
    public function encodeStack(Stack $stack): SigValues {
        ...
        return new SigValues(ScriptFactory::pushAll($scriptSigChunks), new ScriptWitness(...$witness));
    }
