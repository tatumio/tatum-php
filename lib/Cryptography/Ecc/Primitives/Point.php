...
use Tatum\Cryptography\Ecc\Exception\PointException;
use Tatum\Cryptography\Ecc\Exception\PointNotOnCurveException;
...
class Point implements PointInterface {
    ...
    /**
     * {@inheritDoc}
     * @see \Tatum\Cryptography\Ecc\Primitives\PointInterface::isInfinity()
     */
    ...
    /**
     * {@inheritDoc}
     * @see \Tatum\Cryptography\Ecc\Primitives\PointInterface::getCurve()
     */
    ...
    /**
     * {@inheritDoc}
     * @see \Tatum\Cryptography\Ecc\Primitives\PointInterface::getOrder()
     */
    ...
    /**
     * {@inheritDoc}
     * @see \Tatum\Cryptography\Ecc\Primitives\PointInterface::getX()
     */
    ...
    /**
     * {@inheritDoc}
     * @see \Tatum\Cryptography\Ecc\Primitives\PointInterface::getY()
     */
    ...
    /**
     * {@inheritDoc}
     * @see \Tatum\Cryptography\Ecc\Primitives\PointInterface::add()
     * @return self
     */
    public function add(PointInterface $addend): PointInterface {
        ...
        $slope = $modMath->div($math->sub($addend->getY(), $this->y), $math->sub($addend->getX(), $this->x));

        $xR = $modMath->sub($math->sub($math->pow($slope, 2), $this->x), $addend->getX());

        $yR = $modMath->sub($math->mul($slope, $math->sub($this->x, $xR)), $this->y);
    ...
    /**
     * {@inheritDoc}
     * @see \Tatum\Cryptography\Ecc\Primitives\PointInterface::cmp()
     */
    ...
    /**
     * {@inheritDoc}
     * @see \Tatum\Cryptography\Ecc\Primitives\PointInterface::equals()
     */
    ...
    /**
     * {@inheritDoc}
     * @see \Tatum\Cryptography\Ecc\Primitives\PointInterface::mul()
     */
    ...
    /**
     * {@inheritDoc}
     * @see \Tatum\Cryptography\Ecc\Primitives\PointInterface::getDouble()
     * @return self
     */
    public function getDouble(): PointInterface {
        ...
        $tangent = $modMath->div($math->add($threeX2, $a), $math->mul(gmp_init(2, 10), $this->y));

        $x3 = $modMath->sub($math->pow($tangent, 2), $math->mul(gmp_init(2, 10), $this->x));
    ...
    /**
     * {@inheritDoc}
     * @see \Tatum\Cryptography\Ecc\Primitives\PointInterface::__toString()
     */
    public function __toString(): string {
        ...
        return "[ (" .
            $this->adapter->toString($this->x) .
            "," .
            $this->adapter->toString($this->y) .
            ") on " .
            (string) $this->curve .
            " ]";
    }
