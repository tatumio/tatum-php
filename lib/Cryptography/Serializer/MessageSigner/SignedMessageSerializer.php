...
namespace Tatum\Cryptography\Serializer\MessageSigner;
!defined("TATUM-SDK") && exit();

use Tatum\Cryptography\Crypto\EcAdapter\Serializer\Signature\CompactSignatureSerializerInterface;
use Tatum\Cryptography\MessageSigner\SignedMessage;
...
class SignedMessageSerializer {
    ...
    public function serialize(SignedMessage $signedMessage): BufferInterface {
        $content =
            ...
            self::SIG_START .
            PHP_EOL .
            base64_encode($signedMessage->getCompactSignature()->getBinary()) .
            PHP_EOL .
            self::FOOTER;
