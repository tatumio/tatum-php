...
use Tatum\Cryptography\Web3\Contracts\Ethabi;
use Tatum\Cryptography\Web3\Contracts\Types\Address;
use Tatum\Cryptography\Web3\Contracts\Types\Boolean;
use Tatum\Cryptography\Web3\Contracts\Types\Bytes;
use Tatum\Cryptography\Web3\Contracts\Types\DynamicBytes;
use Tatum\Cryptography\Web3\Contracts\Types\Integer;
use Tatum\Cryptography\Web3\Contracts\Types\Str;
use Tatum\Cryptography\Web3\Contracts\Types\Uinteger;
...
class Contract {
     ...
     * ethabi
     *
     * @var \Tatum\Cryptography\Web3\Contracts\Ethabi
     */
    protected $ethabi;
        ...
        if (isset($this->constructor)) {
            ...
            if (count($arguments) < $input_count) {
                throw new InvalidArgumentException(
                    "Please make sure you have put all constructor params and callback."
                );
            }
