...
use Tatum\Cryptography\Exceptions\InvalidDerivationException;
...
class HierarchicalKey {
    ...
    public function __construct(
        ...
        ScriptDataFactory $scriptDataFactory,
        int $depth,
        ...
        if ($sequence < 0 || $sequence > IntRange::U32_MAX) {
            throw new \InvalidArgumentException(
                "Invalid sequence for BIP32 key, must be in range [0 - (2^31)-1] inclusive"
            );
        }
    ...
    /**
     * @return \Tatum\Cryptography\Key\KeyToScript\ScriptAndSignData
     */
     ...
     * @param int $sequence
     * @return HierarchicalKey
     * @throws \Tatum\Cryptography\Exceptions\InvalidDerivationException
     */
        ...
        for ($i = 0; $i < $numParts; $i++) {
            try {
                ...
                if ($i === $numParts - 1) {
                    ...
                    throw new InvalidDerivationException(
