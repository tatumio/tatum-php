...
use Tatum\Cryptography\Exceptions\MissingBech32Prefix;
use Tatum\Cryptography\Exceptions\MissingBip32Prefix;
use Tatum\Cryptography\Exceptions\MissingNetworkParameter;
...
class Network implements NetworkInterface {
    ...
    public function __construct() {
        ...
        if (count($this->bip32ScriptTypeMap) !== count($this->bip32PrefixMap)) {
            throw new InvalidNetworkParameter(
                "BIP32 prefixes not configured correctly. Number of items does not match."
            );
        }
    }
