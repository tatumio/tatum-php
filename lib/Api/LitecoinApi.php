...
class LitecoinApi extends AbstractApi {
    ...
    public function ltcTransactionAddress($ltc_transaction_address) { 
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", $rPath, $rPath, [], $rHeaders, [], $ltc_transaction_address
            ), 
    ...
    public function ltcTransactionAddressKMS($ltc_transaction_address_kms) { 
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", $rPath, $rPath, [], $rHeaders, [], $ltc_transaction_address_kms
            ), 
            "\Tatum\Model\TransactionSigned"
        );
    ...
    public function ltcTransactionUTXO($ltc_transaction_utxo) { 
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", $rPath, $rPath, [], $rHeaders, [], $ltc_transaction_utxo
            ), 
            "\Tatum\Model\TransactionSigned"
        );
    ...
    public function ltcTransactionUTXOKMS($ltc_transaction_utxokms) { 
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", $rPath, $rPath, [], $rHeaders, [], $ltc_transaction_utxokms
            ), 
            "\Tatum\Model\TransactionSigned"
        );
