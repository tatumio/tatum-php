...
class GasPumpApi extends AbstractApi {
    ...
    public function blockchainScCustodialApproveTransferCustodialWallet(\Tatum\Model\ApproveTransferCustodialWallet $approve_transfer_custodial_wallet) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/approve#postApproveTransferCustodialWallet", [], $rHeaders, [], $approve_transfer_custodial_wallet
            ), 
    ...
    public function blockchainScCustodialApproveTransferCustodialWalletCelo(\Tatum\Model\ApproveTransferCustodialWalletCelo $approve_transfer_custodial_wallet_celo) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/approve#postApproveTransferCustodialWalletCelo", [], $rHeaders, [], $approve_transfer_custodial_wallet_celo
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialApproveTransferCustodialWalletCeloKMS(\Tatum\Model\ApproveTransferCustodialWalletCeloKMS $approve_transfer_custodial_wallet_celo_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/approve#postApproveTransferCustodialWalletCeloKMS", [], $rHeaders, [], $approve_transfer_custodial_wallet_celo_kms
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialApproveTransferCustodialWalletKMS(\Tatum\Model\ApproveTransferCustodialWalletKMS $approve_transfer_custodial_wallet_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/approve#postApproveTransferCustodialWalletKMS", [], $rHeaders, [], $approve_transfer_custodial_wallet_kms
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialBatchGenerateCustodialWalletBatch(\Tatum\Model\GenerateCustodialWalletBatch $generate_custodial_wallet_batch, string $x_testnet_type = 'ethereum-sepolia') {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/batch#postGenerateCustodialWalletBatch", [], $rHeaders, [], $generate_custodial_wallet_batch
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialBatchGenerateCustodialWalletBatchCelo(\Tatum\Model\GenerateCustodialWalletBatchCelo $generate_custodial_wallet_batch_celo, string $x_testnet_type = 'ethereum-sepolia') {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/batch#postGenerateCustodialWalletBatchCelo", [], $rHeaders, [], $generate_custodial_wallet_batch_celo
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialBatchGenerateCustodialWalletBatchCeloKMS(\Tatum\Model\GenerateCustodialWalletBatchCeloKMS $generate_custodial_wallet_batch_celo_kms, string $x_testnet_type = 'ethereum-sepolia') {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/batch#postGenerateCustodialWalletBatchCeloKMS", [], $rHeaders, [], $generate_custodial_wallet_batch_celo_kms
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialBatchGenerateCustodialWalletBatchKMS(\Tatum\Model\GenerateCustodialWalletBatchKMS $generate_custodial_wallet_batch_kms, string $x_testnet_type = 'ethereum-sepolia') {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/batch#postGenerateCustodialWalletBatchKMS", [], $rHeaders, [], $generate_custodial_wallet_batch_kms
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialBatchGenerateCustodialWalletBatchPayer(\Tatum\Model\GenerateCustodialWalletBatchPayer $generate_custodial_wallet_batch_payer, string $x_testnet_type = 'ethereum-sepolia') {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/batch#postGenerateCustodialWalletBatchPayer", [], $rHeaders, [], $generate_custodial_wallet_batch_payer
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialBatchGenerateCustodialWalletBatchTron(\Tatum\Model\GenerateCustodialWalletBatchTron $generate_custodial_wallet_batch_tron, string $x_testnet_type = 'ethereum-sepolia') {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/batch#postGenerateCustodialWalletBatchTron", [], $rHeaders, [], $generate_custodial_wallet_batch_tron
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialBatchGenerateCustodialWalletBatchTronKMS(\Tatum\Model\GenerateCustodialWalletBatchTronKMS $generate_custodial_wallet_batch_tron_kms, string $x_testnet_type = 'ethereum-sepolia') {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/batch#postGenerateCustodialWalletBatchTronKMS", [], $rHeaders, [], $generate_custodial_wallet_batch_tron_kms
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialGenerateCustodialWallet(\Tatum\Model\GenerateCustodialWallet $generate_custodial_wallet) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial#postGenerateCustodialWallet", [], $rHeaders, [], $generate_custodial_wallet
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialGenerateCustodialWalletCelo(\Tatum\Model\GenerateCustodialWalletCelo $generate_custodial_wallet_celo) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial#postGenerateCustodialWalletCelo", [], $rHeaders, [], $generate_custodial_wallet_celo
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialGenerateCustodialWalletCeloKMS(\Tatum\Model\GenerateCustodialWalletCeloKMS $generate_custodial_wallet_celo_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial#postGenerateCustodialWalletCeloKMS", [], $rHeaders, [], $generate_custodial_wallet_celo_kms
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialGenerateCustodialWalletKMS(\Tatum\Model\GenerateCustodialWalletKMS $generate_custodial_wallet_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial#postGenerateCustodialWalletKMS", [], $rHeaders, [], $generate_custodial_wallet_kms
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialGenerateCustodialWalletTron(\Tatum\Model\GenerateCustodialWalletTron $generate_custodial_wallet_tron) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial#postGenerateCustodialWalletTron", [], $rHeaders, [], $generate_custodial_wallet_tron
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialGenerateCustodialWalletTronKMS(\Tatum\Model\GenerateCustodialWalletTronKMS $generate_custodial_wallet_tron_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial#postGenerateCustodialWalletTronKMS", [], $rHeaders, [], $generate_custodial_wallet_tron_kms
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialTransferBatchTransferCustodialWalletBatch(\Tatum\Model\TransferCustodialWalletBatch $transfer_custodial_wallet_batch) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/transfer/batch#postTransferCustodialWalletBatch", [], $rHeaders, [], $transfer_custodial_wallet_batch
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialTransferBatchTransferCustodialWalletBatchCelo(\Tatum\Model\TransferCustodialWalletBatchCelo $transfer_custodial_wallet_batch_celo) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/transfer/batch#postTransferCustodialWalletBatchCelo", [], $rHeaders, [], $transfer_custodial_wallet_batch_celo
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialTransferBatchTransferCustodialWalletBatchCeloKMS(\Tatum\Model\TransferCustodialWalletBatchCeloKMS $transfer_custodial_wallet_batch_celo_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/transfer/batch#postTransferCustodialWalletBatchCeloKMS", [], $rHeaders, [], $transfer_custodial_wallet_batch_celo_kms
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialTransferBatchTransferCustodialWalletBatchKMS(\Tatum\Model\TransferCustodialWalletBatchKMS $transfer_custodial_wallet_batch_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/transfer/batch#postTransferCustodialWalletBatchKMS", [], $rHeaders, [], $transfer_custodial_wallet_batch_kms
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialTransferBatchTransferCustodialWalletBatchTron(\Tatum\Model\TransferCustodialWalletBatchTron $transfer_custodial_wallet_batch_tron) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/transfer/batch#postTransferCustodialWalletBatchTron", [], $rHeaders, [], $transfer_custodial_wallet_batch_tron
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialTransferBatchTransferCustodialWalletBatchTronKMS(\Tatum\Model\TransferCustodialWalletBatchTronKMS $transfer_custodial_wallet_batch_tron_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/transfer/batch#postTransferCustodialWalletBatchTronKMS", [], $rHeaders, [], $transfer_custodial_wallet_batch_tron_kms
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialTransferCustodialWallet(\Tatum\Model\TransferCustodialWallet $transfer_custodial_wallet) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/transfer#postTransferCustodialWallet", [], $rHeaders, [], $transfer_custodial_wallet
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialTransferCustodialWalletCelo(\Tatum\Model\TransferCustodialWalletCelo $transfer_custodial_wallet_celo) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/transfer#postTransferCustodialWalletCelo", [], $rHeaders, [], $transfer_custodial_wallet_celo
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialTransferCustodialWalletCeloKMS(\Tatum\Model\TransferCustodialWalletCeloKMS $transfer_custodial_wallet_celo_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/transfer#postTransferCustodialWalletCeloKMS", [], $rHeaders, [], $transfer_custodial_wallet_celo_kms
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialTransferCustodialWalletKMS(\Tatum\Model\TransferCustodialWalletKMS $transfer_custodial_wallet_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/transfer#postTransferCustodialWalletKMS", [], $rHeaders, [], $transfer_custodial_wallet_kms
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialTransferCustodialWalletTron(\Tatum\Model\TransferCustodialWalletTron $transfer_custodial_wallet_tron) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/transfer#postTransferCustodialWalletTron", [], $rHeaders, [], $transfer_custodial_wallet_tron
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function blockchainScCustodialTransferCustodialWalletTronKMS(\Tatum\Model\TransferCustodialWalletTronKMS $transfer_custodial_wallet_tron_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/blockchain/sc/custodial/transfer#postTransferCustodialWalletTronKMS", [], $rHeaders, [], $transfer_custodial_wallet_tron_kms
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function gasPumpActivateGasPump(\Tatum\Model\ActivateGasPump $activate_gas_pump) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/gas-pump/activate#postActivateGasPump", [], $rHeaders, [], $activate_gas_pump
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function gasPumpActivateGasPumpCelo(\Tatum\Model\ActivateGasPumpCelo $activate_gas_pump_celo) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/gas-pump/activate#postActivateGasPumpCelo", [], $rHeaders, [], $activate_gas_pump_celo
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function gasPumpActivateGasPumpCeloKMS(\Tatum\Model\ActivateGasPumpCeloKMS $activate_gas_pump_celo_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/gas-pump/activate#postActivateGasPumpCeloKMS", [], $rHeaders, [], $activate_gas_pump_celo_kms
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function gasPumpActivateGasPumpKMS(\Tatum\Model\ActivateGasPumpKMS $activate_gas_pump_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/gas-pump/activate#postActivateGasPumpKMS", [], $rHeaders, [], $activate_gas_pump_kms
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function gasPumpActivateGasPumpTatum(\Tatum\Model\ActivateGasPumpTatum $activate_gas_pump_tatum) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/gas-pump/activate#postActivateGasPumpTatum", [], $rHeaders, [], $activate_gas_pump_tatum
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function gasPumpActivateGasPumpTron(\Tatum\Model\ActivateGasPumpTron $activate_gas_pump_tron) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/gas-pump/activate#postActivateGasPumpTron", [], $rHeaders, [], $activate_gas_pump_tron
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
    ...
    public function gasPumpActivateGasPumpTronKMS(\Tatum\Model\ActivateGasPumpTronKMS $activate_gas_pump_tron_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/gas-pump/activate#postActivateGasPumpTronKMS", [], $rHeaders, [], $activate_gas_pump_tron_kms
            ), 
            "\Tatum\Model\BitcoinTransactionBtcTransactionFromAddress200Response"
        );
