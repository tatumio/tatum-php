 ...
 * @package   Tatum
 * @author    Mark Jivko
 * @see       https://apidoc.tatum.io/tag/VeChain
 *
...
class VeChainApi extends AbstractApi {
    ...
    public function vetTransactionTransferVetBlockchain(\Tatum\Model\TransferVetBlockchain $transfer_vet_blockchain) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/vet/transaction#postTransferVetBlockchain", [], $rHeaders, [], $transfer_vet_blockchain
            ), 
            "\Tatum\Model\TransactionHash"
        );
    ...
    public function vetTransactionTransferVetBlockchainKMS(\Tatum\Model\TransferVetBlockchainKMS $transfer_vet_blockchain_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", "/v3/vet/transaction#postTransferVetBlockchainKMS", [], $rHeaders, [], $transfer_vet_blockchain_kms
            ), 
            "\Tatum\Model\TransactionHash"
        );
