...
class StellarApi extends AbstractApi {
    ...
    public function transferXlmBlockchain($transfer_xlm_blockchain) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", $rPath, $rPath, [], $rHeaders, [], $transfer_xlm_blockchain
            ), 
    ...
    public function transferXlmBlockchainAsset($transfer_xlm_blockchain_asset) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", $rPath, $rPath, [], $rHeaders, [], $transfer_xlm_blockchain_asset
            ), 
            "\Tatum\Model\TransactionSigned"
        );
    ...
    public function transferXlmBlockchainKMS($transfer_xlm_blockchain_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", $rPath, $rPath, [], $rHeaders, [], $transfer_xlm_blockchain_kms
            ), 
            "\Tatum\Model\TransactionSigned"
        );
    ...
    public function transferXlmBlockchainKMSAsset($transfer_xlm_blockchain_kms_asset) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", $rPath, $rPath, [], $rHeaders, [], $transfer_xlm_blockchain_kms_asset
            ), 
            "\Tatum\Model\TransactionSigned"
        );
    ...
    public function trustLineXlmBlockchain($trust_line_xlm_blockchain) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", $rPath, $rPath, [], $rHeaders, [], $trust_line_xlm_blockchain
            ), 
            "\Tatum\Model\TransactionSigned"
        );
    ...
    public function trustLineXlmBlockchainKMS($trust_line_xlm_blockchain_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "POST", $rPath, $rPath, [], $rHeaders, [], $trust_line_xlm_blockchain_kms
            ), 
            "\Tatum\Model\TransactionSigned"
        );
    ...
    public function xlmGetLedger($sequence) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), "GET", S::parse($rPath, ["sequence" => $sequence]), $rPath, [], $rHeaders, []
            ), 
            "\Tatum\Model\XlmLedger"
        );
