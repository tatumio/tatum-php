 ...
 * Error403VCDuplicate Model
 */
class Error403VCDuplicate extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403VCDuplicate";
     ...
     * Set error_code
     * 
     * @param string $error_code virtual.duplicate
     ...
     * Set message
     * 
     * @param string $message Virtual currency with given name already exists.
     * @throws \InvalidArgumentException
     * @return $this
     */
