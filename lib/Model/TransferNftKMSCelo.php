...
class TransferNftKMSCelo extends AbstractModel {
    ...
    public function __construct(array $data = []) {
        foreach(["value"=>null, "chain"=>null, "to"=>null, "token_id"=>null, "contract_address"=>null, "provenance"=>null, "provenance_data"=>null, "token_price"=>null, "index"=>null, "signature_id"=>null, "nonce"=>null, "fee_currency"=>null] as $k => $v) {
    ...
    public function setChain(string $chain) {
        ...
        if (!in_array($chain, $allowed, true)) {
            throw new IAE(sprintf("TransferNftKMSCelo.setChain: chain invalid value '%s', must be one of '%s'", $chain, implode("', '", $allowed)));
        }
    ...
    public function setTo(string $to) {
        if ((mb_strlen($to) > 42)) {
            throw new IAE('TransferNftKMSCelo.setTo: $to length must be <= 42');
        }
        if ((mb_strlen($to) < 42)) {
            throw new IAE('TransferNftKMSCelo.setTo: $to length must be >= 42');
        }
    ...
    public function setTokenId(string $token_id) {
        if ((mb_strlen($token_id) > 78)) {
            throw new IAE('TransferNftKMSCelo.setTokenId: $token_id length must be <= 78');
        }
    ...
    public function setContractAddress(string $contract_address) {
        if ((mb_strlen($contract_address) > 42)) {
            throw new IAE('TransferNftKMSCelo.setContractAddress: $contract_address length must be <= 42');
        }
        if ((mb_strlen($contract_address) < 42)) {
            throw new IAE('TransferNftKMSCelo.setContractAddress: $contract_address length must be >= 42');
        }
    ...
    public function setTokenPrice(?string $token_price) {
        if (!is_null($token_price) && (mb_strlen($token_price) > 256)) {
            throw new IAE('TransferNftKMSCelo.setTokenPrice: $token_price length must be <= 256');
        }
    ...
    public function setIndex(?float $index) {
        if (!is_null($index) && ($index < 0)) {
            throw new IAE('TransferNftKMSCelo.setIndex: $index must be >=0');
        }
    ...
    public function setFeeCurrency(string $fee_currency) {
        ...
        if (!in_array($fee_currency, $allowed, true)) {
            throw new IAE(sprintf("TransferNftKMSCelo.setFeeCurrency: fee_currency invalid value '%s', must be one of '%s'", $fee_currency, implode("', '", $allowed)));
        }
