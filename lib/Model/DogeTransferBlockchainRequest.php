...
/**
 * DogeTransferBlockchain_request Model
 *
 ...
 * DogeTransferBlockchain_request Model
 */
class DogeTransferBlockchainRequest extends AbstractModel {

    public const DISCRIMINATOR = null;
    protected static $_name = "DogeTransferBlockchain_request";
    protected static $_definition = [
        "from_utxo" => ["fromUTXO", "\Tatum\Model\DogeTransactionUTXOKMSFromUTXOInner[]", null, "getFromUtxo", "setFromUtxo", null, ["r" => 1, "c" => 1]], 
        "to" => ["to", "\Tatum\Model\DogeTransactionUTXOKMSToInner[]", null, "getTo", "setTo", null, ["r" => 1, "c" => 1]], 
     ...
     * Set from_utxo
     * 
     * @param \Tatum\Model\DogeTransactionUTXOKMSFromUTXOInner[] $from_utxo The array of transaction hashes, indexes of its UTXOs, and the signature IDs of the associated blockchain addresses
     ...
     * Set fee
     * 
     * @param string|null $fee The fee to be paid for the transaction (in DOGE); if you are using this parameter, you have to also use the <code>changeAddress</code> parameter because these two parameters only work together.
     * @throws \InvalidArgumentException
     * @return $this
     */
