...
class DogeTransferBlockchainRequest extends AbstractModel {
    ...
    protected static $_definition = [
        "from_utxo" => ["fromUTXO", "\Tatum\Model\DogeTransactionUTXOKMSFromUTXOInner[]", null, "getFromUtxo", "setFromUtxo"], 
        "to" => ["to", "\Tatum\Model\DogeTransactionUTXOKMSToInner[]", null, "getTo", "setTo"], 
