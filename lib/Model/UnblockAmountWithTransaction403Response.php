...
/**
 * unblockAmountWithTransaction_403_response Model
 *
 ...
 * unblockAmountWithTransaction_403_response Model
 */
class UnblockAmountWithTransaction403Response extends AbstractModel {

    public const _D = null;
    protected static $_name = "unblockAmountWithTransaction_403_response";
     ...
     * Set error_code
     * 
     * @param string $error_code transaction.not.compliant
     ...
     * Set message
     * 
     * @param string $message Transaction not compliant, recipient account customer country is not defined.
     * @throws \InvalidArgumentException
     * @return $this
     */
