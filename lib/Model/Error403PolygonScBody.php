 ...
 * Error403PolygonScBody Model
 */
class Error403PolygonScBody extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403PolygonScBody";
     ...
     * Set error_code
     * 
     * @param string $error_code polygon.sc.invalid
     ...
     * Set message
     * 
     * @param string $message Invalid parameters for smart contract invocation.
     * @throws \InvalidArgumentException
     * @return $this
     */
