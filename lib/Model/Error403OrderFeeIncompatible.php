...
/**
 * Error403OrderFeeIncompatible Model
 *
 ...
 * Error403OrderFeeIncompatible Model
 */
class Error403OrderFeeIncompatible extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403OrderFeeIncompatible";
     ...
     * Set error_code
     * 
     * @param string $error_code trade.currency.fee
     ...
     * Set message
     * 
     * @param string $message Incompatible currencies for currency1 and fee account.
     * @throws \InvalidArgumentException
     * @return $this
     */
