...
/**
 * BtcTransactionFromUTXOKMSTarget Model
 *
 ...
 * BtcTransactionFromUTXOKMSTarget Model
 */
class BtcTransactionFromUTXOKMSTarget extends AbstractModel {

    public const DISCRIMINATOR = null;
    protected static $_name = "BtcTransactionFromUTXOKMSTarget";
    ...
    public function setValue(float $value) {
        if (($value < 0)) {
            throw new IAE('BtcTransactionFromUTXOKMSTarget.setValue: $value must be >=0');
        }
