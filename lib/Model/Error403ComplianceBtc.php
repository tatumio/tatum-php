 ...
 * Error403ComplianceBtc Model
 */
class Error403ComplianceBtc extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403ComplianceBtc";
     ...
     * Set error_code
     * 
     * @param string $error_code compliance.country.btc.not.supported
     ...
     * Set message
     * 
     * @param string $message Customer country not supported for BTC.
     * @throws \InvalidArgumentException
     * @return $this
     */
