...
/**
 * deactivateAccount_403_response Model
 *
 ...
 * deactivateAccount_403_response Model
 */
class DeactivateAccount403Response extends AbstractModel {

    public const _D = null;
    protected static $_name = "deactivateAccount_403_response";
     ...
     * Set error_code
     * 
     * @param string $error_code account.trade.non.zero
     ...
     * Set message
     * 
     * @param string $message Unable to deactivate account with non-zero exchange trades.
     * @throws \InvalidArgumentException
     * @return $this
     */
