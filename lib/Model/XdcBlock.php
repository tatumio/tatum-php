...
class XdcBlock extends AbstractModel {
    ...
    protected static $_definition = [
        ...
        "transactions" => ["transactions", "\Tatum\Model\XdcTx[]", null, "getTransactions", "setTransactions", null, ["r" => 0, "c" => 1]], 
        "uncles" => ["uncles", "string[]", null, "getUncles", "setUncles", null, ["r" => 0, "c" => 1]]
    ];
    ...
    public function setUncles(?array $uncles) {
        return $this->_set("uncles", $uncles);
    }
}
