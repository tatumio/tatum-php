 ...
 * Error403TxBalance Model
 */
class Error403TxBalance extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403TxBalance";
     ...
     * Set error_code
     * 
     * @param string $error_code balance.insufficient
     ...
     * Set message
     * 
     * @param string $message Insufficient balance for account ${transaction.senderAccountId} and payment amount ${transaction.amount}. Sender balance is ${senderAccount.balance.availableBalance as string}, amount is ${amount}
     * @throws \InvalidArgumentException
     * @return $this
     */
