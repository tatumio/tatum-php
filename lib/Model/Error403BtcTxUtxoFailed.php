 ...
 * Error403BtcTxUtxoFailed Model
 */
class Error403BtcTxUtxoFailed extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403BtcTxUtxoFailed";
     ...
     * Set error_code
     * 
     * @param string $error_code transaction.preparation.failed.utxo
     ...
     * Set message
     * 
     * @param string $message Impossible to find last UTXO.
     * @throws \InvalidArgumentException
     * @return $this
     */
