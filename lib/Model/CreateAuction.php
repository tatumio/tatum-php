 ...
 * CreateAuction Model
 */
class CreateAuction extends AbstractModel {
    ...
    public function setChain(string $chain) {
        ...
        if (!in_array($chain, $allowed, true)) {
            throw new IAE(sprintf("CreateAuction.setChain: chain invalid value '%s', must be one of '%s'", $chain, implode("', '", $allowed)));
        }
    ...
    public function setContractAddress(string $contract_address) {
        if ((mb_strlen($contract_address) > 42)) {
            throw new IAE('CreateAuction.setContractAddress: $contract_address length must be <= 42');
        }
        if ((mb_strlen($contract_address) < 42)) {
            throw new IAE('CreateAuction.setContractAddress: $contract_address length must be >= 42');
        }
    ...
    public function setNftAddress(string $nft_address) {
        if ((mb_strlen($nft_address) > 42)) {
            throw new IAE('CreateAuction.setNftAddress: $nft_address length must be <= 42');
        }
        if ((mb_strlen($nft_address) < 42)) {
            throw new IAE('CreateAuction.setNftAddress: $nft_address length must be >= 42');
        }
    ...
    public function setSeller(string $seller) {
        if ((mb_strlen($seller) > 42)) {
            throw new IAE('CreateAuction.setSeller: $seller length must be <= 42');
        }
        if ((mb_strlen($seller) < 42)) {
            throw new IAE('CreateAuction.setSeller: $seller length must be >= 42');
        }
    ...
    public function setErc20Address(?string $erc20_address) {
        if (!is_null($erc20_address) && (mb_strlen($erc20_address) > 42)) {
            throw new IAE('CreateAuction.setErc20Address: $erc20_address length must be <= 42');
        }
        if (!is_null($erc20_address) && (mb_strlen($erc20_address) < 42)) {
            throw new IAE('CreateAuction.setErc20Address: $erc20_address length must be >= 42');
        }
    ...
    public function setId(string $id) {
        if ((mb_strlen($id) > 200)) {
            throw new IAE('CreateAuction.setId: $id length must be <= 200');
        }
        if ((mb_strlen($id) < 1)) {
            throw new IAE('CreateAuction.setId: $id length must be >= 1');
        }
        $this->_data['id'] = $id;
    ...
    public function setAmount(?string $amount) {
        if (!is_null($amount) && (!preg_match("/^[+]?((\\d+(\\.\\d*)?)|(\\.\\d+))$/", $amount))) {
            throw new IAE('CreateAuction.setAmount: $amount must match /^[+]?((\\d+(\\.\\d*)?)|(\\.\\d+))$/, ' . var_export($amount, true) . ' given');
        }
    ...
    public function setTokenId(string $token_id) {
        if ((mb_strlen($token_id) > 256)) {
            throw new IAE('CreateAuction.setTokenId: $token_id length must be <= 256');
        }
    ...
    public function setEndedAt(float $ended_at) {
        if (($ended_at < 0)) {
            throw new IAE('CreateAuction.setEndedAt: $ended_at must be >=0');
        }
    ...
    public function setFromPrivateKey(string $from_private_key) {
        if ((mb_strlen($from_private_key) > 66)) {
            throw new IAE('CreateAuction.setFromPrivateKey: $from_private_key length must be <= 66');
        }
        if ((mb_strlen($from_private_key) < 66)) {
            throw new IAE('CreateAuction.setFromPrivateKey: $from_private_key length must be >= 66');
        }
