...
class CallKcsSmartContractMethodKMS extends AbstractModel {
    ...
    public function setContractAddress(string $contract_address) {
        if ((mb_strlen($contract_address) > 42)) {
            throw new IAE('CallKcsSmartContractMethodKMS.setContractAddress: $contract_address length must be <= 42');
        }
        if ((mb_strlen($contract_address) < 42)) {
            throw new IAE('CallKcsSmartContractMethodKMS.setContractAddress: $contract_address length must be >= 42');
        }
    ...
    public function setMethodName(string $method_name) {
        if ((mb_strlen($method_name) > 500)) {
            throw new IAE('CallKcsSmartContractMethodKMS.setMethodName: $method_name length must be <= 500');
        }
        if ((mb_strlen($method_name) < 1)) {
            throw new IAE('CallKcsSmartContractMethodKMS.setMethodName: $method_name length must be >= 1');
        }
    ...
    public function setIndex(?float $index) {
        if (!is_null($index) && ($index < 0)) {
            throw new IAE('CallKcsSmartContractMethodKMS.setIndex: $index must be >=0');
        }
    ...
    public function setNonce(?float $nonce) {
        if (!is_null($nonce) && ($nonce < 0)) {
            throw new IAE('CallKcsSmartContractMethodKMS.setNonce: $nonce must be >=0');
        }
