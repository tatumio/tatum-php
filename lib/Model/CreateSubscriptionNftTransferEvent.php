...
/**
 * CreateSubscriptionNftTransferEvent Model
 *
 * @version   3.17.1
 ...
 * CreateSubscriptionNftTransferEvent Model
 */
class CreateSubscriptionNftTransferEvent extends AbstractModel {

    public const DISCRIMINATOR = null;
    public const TYPE_CONTRACT_NFT_TXS_PER_BLOCK = 'CONTRACT_NFT_TXS_PER_BLOCK';
    protected static $_name = "CreateSubscriptionNftTransferEvent";
    protected static $_definition = [
        "type" => ["type", "string", null, "getType", "setType"], 
        "attr" => ["attr", "\Tatum\Model\CreateSubscriptionMultiTokenTransferEventAttr", null, "getAttr", "setAttr"]
    ];
    ...
    public function getTypeAllowableValues(): array {
        return [
            self::TYPE_CONTRACT_NFT_TXS_PER_BLOCK,
        ];
    }
    ...
    public function setType(string $type) {
        ...
        if (!in_array($type, $allowed, true)) {
            throw new IAE(sprintf("CreateSubscriptionNftTransferEvent.setType: type invalid value '%s', must be one of '%s'", $type, implode("', '", $allowed)));
        }
