 ...
 * BidOnAuctionCeloKMS Model
 */
class BidOnAuctionCeloKMS extends AbstractModel {
    ...
    public function setChain(string $chain) {
        ...
        if (!in_array($chain, $allowed, true)) {
            throw new IAE(sprintf("BidOnAuctionCeloKMS.setChain: chain invalid value '%s', must be one of '%s'", $chain, implode("', '", $allowed)));
        }
    ...
    public function setFeeCurrency(string $fee_currency) {
        ...
        if (!in_array($fee_currency, $allowed, true)) {
            throw new IAE(sprintf("BidOnAuctionCeloKMS.setFeeCurrency: fee_currency invalid value '%s', must be one of '%s'", $fee_currency, implode("', '", $allowed)));
        }
    ...
    public function setContractAddress(string $contract_address) {
        if ((mb_strlen($contract_address) > 42)) {
            throw new IAE('BidOnAuctionCeloKMS.setContractAddress: $contract_address length must be <= 42');
        }
        if ((mb_strlen($contract_address) < 42)) {
            throw new IAE('BidOnAuctionCeloKMS.setContractAddress: $contract_address length must be >= 42');
        }
    ...
    public function setErc20Address(?string $erc20_address) {
        if (!is_null($erc20_address) && (mb_strlen($erc20_address) > 42)) {
            throw new IAE('BidOnAuctionCeloKMS.setErc20Address: $erc20_address length must be <= 42');
        }
        if (!is_null($erc20_address) && (mb_strlen($erc20_address) < 42)) {
            throw new IAE('BidOnAuctionCeloKMS.setErc20Address: $erc20_address length must be >= 42');
        }
    ...
    public function setBidder(?string $bidder) {
        if (!is_null($bidder) && (mb_strlen($bidder) > 42)) {
            throw new IAE('BidOnAuctionCeloKMS.setBidder: $bidder length must be <= 42');
        }
        if (!is_null($bidder) && (mb_strlen($bidder) < 42)) {
            throw new IAE('BidOnAuctionCeloKMS.setBidder: $bidder length must be >= 42');
        }
    ...
    public function setId(string $id) {
        if ((mb_strlen($id) > 200)) {
            throw new IAE('BidOnAuctionCeloKMS.setId: $id length must be <= 200');
        }
        if ((mb_strlen($id) < 1)) {
            throw new IAE('BidOnAuctionCeloKMS.setId: $id length must be >= 1');
        }
        $this->_data['id'] = $id;
    ...
    public function setBidValue(string $bid_value) {
        if ((!preg_match("/^[+]?((\\d+(\\.\\d*)?)|(\\.\\d+))$/", $bid_value))) {
            throw new IAE('BidOnAuctionCeloKMS.setBidValue: $bid_value must match /^[+]?((\\d+(\\.\\d*)?)|(\\.\\d+))$/, ' . var_export($bid_value, true) . ' given');
        }
    ...
    public function setIndex(?float $index) {
        if (!is_null($index) && ($index < 0)) {
            throw new IAE('BidOnAuctionCeloKMS.setIndex: $index must be >=0');
        }
