 ...
 * Error403OffchainCheck Model
 */
class Error403OffchainCheck extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403OffchainCheck";
     ...
     * Set error_code
     * 
     * @param string $error_code withdrawal.check.currency
     ...
     * Set message
     * 
     * @param string $message Withdrawal check available only for ETH based currencies.
     * @throws \InvalidArgumentException
     * @return $this
     */
