 ...
 * Error403AccountXpub Model
 */
class Error403AccountXpub extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403AccountXpub";
     ...
     * Set message
     * 
     * @param string $message Unable to create ${account.currency} account with xpub.
     * @throws \InvalidArgumentException
     * @return $this
     */
