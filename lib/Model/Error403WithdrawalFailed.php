...
/**
 * Error403WithdrawalFailed Model
 *
 ...
 * Error403WithdrawalFailed Model
 */
class Error403WithdrawalFailed extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403WithdrawalFailed";
     ...
     * Set error_code
     * 
     * @param string $error_code withdrawal.failed.transaction.failed
     ...
     * Set message
     * 
     * @param string $message Unable to store withdrawal, it is impossible to create transaction.
     * @throws \InvalidArgumentException
     * @return $this
     */
