...
class BtcTransactionFromAddress extends AbstractModel {
    ...
    protected static $_definition = [
        "from_address" => ["fromAddress", "\Tatum\Model\BtcTransactionFromAddressSource[]", null, "getFromAddress", "setFromAddress"], 
        "to" => ["to", "\Tatum\Model\BtcTransactionFromAddressTarget[]", null, "getTo", "setTo"], 
