...
/**
 * Error403CustomerNotExists Model
 *
 ...
 * Error403CustomerNotExists Model
 */
class Error403CustomerNotExists extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403CustomerNotExists";
     ...
     * Set error_code
     * 
     * @param string $error_code customer.not.exists
     ...
     * Set message
     * 
     * @param string $message No customer with given external ID ${externalId} exists.
     * @throws \InvalidArgumentException
     * @return $this
     */
