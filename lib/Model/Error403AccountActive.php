 ...
 * Error403AccountActive Model
 */
class Error403AccountActive extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403AccountActive";
     ...
     * Set error_code
     * 
     * @param string $error_code account.active
     ...
     * Set message
     * 
     * @param string $message Unable to activate active account.
     * @throws \InvalidArgumentException
     * @return $this
     */
