...
/**
 * Error403AddressIndexUsed Model
 *
 ...
 * Error403AddressIndexUsed Model
 */
class Error403AddressIndexUsed extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403AddressIndexUsed";
     ...
     * Set error_code
     * 
     * @param string $error_code Address.index.used
     ...
     * Set message
     * 
     * @param string $message Unable to create address, derivation index is already used.
     * @throws \InvalidArgumentException
     * @return $this
     */
