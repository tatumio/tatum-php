...
/**
 * CancelSellAssetOnMarketplaceCelo Model
 *
 * @version   3.17.1
 ...
 * CancelSellAssetOnMarketplaceCelo Model
 */
class CancelSellAssetOnMarketplaceCelo extends AbstractModel {
    ...
    protected static $_name = "CancelSellAssetOnMarketplaceCelo";
    ...
    public function __construct(array $data = []) {
        foreach(["chain"=>null, "contract_address"=>null, "fee_currency"=>null, "erc20_address"=>null, "listing_id"=>null, "from_private_key"=>null, "nonce"=>null, "fee"=>null] as $k => $v) {
    ...
    public function setChain(string $chain) {
        ...
        if (!in_array($chain, $allowed, true)) {
            throw new IAE(sprintf("CancelSellAssetOnMarketplaceCelo.setChain: chain invalid value '%s', must be one of '%s'", $chain, implode("', '", $allowed)));
        }
    ...
    public function setContractAddress(string $contract_address) {
        if ((mb_strlen($contract_address) > 42)) {
            throw new IAE('CancelSellAssetOnMarketplaceCelo.setContractAddress: $contract_address length must be <= 42');
        }
        if ((mb_strlen($contract_address) < 42)) {
            throw new IAE('CancelSellAssetOnMarketplaceCelo.setContractAddress: $contract_address length must be >= 42');
        }
    ...
    public function setFeeCurrency(string $fee_currency) {
        ...
        if (!in_array($fee_currency, $allowed, true)) {
            throw new IAE(sprintf("CancelSellAssetOnMarketplaceCelo.setFeeCurrency: fee_currency invalid value '%s', must be one of '%s'", $fee_currency, implode("', '", $allowed)));
        }
    ...
    public function setErc20Address(?string $erc20_address) {
        if (!is_null($erc20_address) && (mb_strlen($erc20_address) > 42)) {
            throw new IAE('CancelSellAssetOnMarketplaceCelo.setErc20Address: $erc20_address length must be <= 42');
        }
        if (!is_null($erc20_address) && (mb_strlen($erc20_address) < 42)) {
            throw new IAE('CancelSellAssetOnMarketplaceCelo.setErc20Address: $erc20_address length must be >= 42');
        }
    ...
    public function setListingId(string $listing_id) {
        if ((mb_strlen($listing_id) > 200)) {
            throw new IAE('CancelSellAssetOnMarketplaceCelo.setListingId: $listing_id length must be <= 200');
        }
        if ((mb_strlen($listing_id) < 1)) {
            throw new IAE('CancelSellAssetOnMarketplaceCelo.setListingId: $listing_id length must be >= 1');
        }
    ...
    public function setFromPrivateKey(string $from_private_key) {
        if ((mb_strlen($from_private_key) > 66)) {
            throw new IAE('CancelSellAssetOnMarketplaceCelo.setFromPrivateKey: $from_private_key length must be <= 66');
        }
        if ((mb_strlen($from_private_key) < 66)) {
            throw new IAE('CancelSellAssetOnMarketplaceCelo.setFromPrivateKey: $from_private_key length must be >= 66');
        }
