 ...
 * SolanaNftMetadata Model
 */
class SolanaNftMetadata extends AbstractModel {

    public const DISCRIMINATOR = null;
    protected static $_name = "SolanaNftMetadata";
    ...
    public function setName(string $name) {
        if ((mb_strlen($name) > 255)) {
            throw new IAE('SolanaNftMetadata.setName: $name length must be <= 255');
        }
    ...
    public function setSymbol(string $symbol) {
        if ((mb_strlen($symbol) > 255)) {
            throw new IAE('SolanaNftMetadata.setSymbol: $symbol length must be <= 255');
        }
    ...
    public function setUri(string $uri) {
        if ((mb_strlen($uri) > 500)) {
            throw new IAE('SolanaNftMetadata.setUri: $uri length must be <= 500');
        }
        $this->_data['uri'] = $uri;
    ...
    public function setCollection(?string $collection) {
        if (!is_null($collection) && (mb_strlen($collection) > 44)) {
            throw new IAE('SolanaNftMetadata.setCollection: $collection length must be <= 44');
        }
        if (!is_null($collection) && (mb_strlen($collection) < 43)) {
            throw new IAE('SolanaNftMetadata.setCollection: $collection length must be >= 43');
        }
