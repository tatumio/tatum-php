 ...
 * Error403BnbTxFailed Model
 */
class Error403BnbTxFailed extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403BnbTxFailed";
     ...
     * Set error_code
     * 
     * @param string $error_code bnb.transfer.failed
     ...
     * Set message
     * 
     * @param string $message Unable to transfer funds. ${error}
     * @throws \InvalidArgumentException
     * @return $this
     */
