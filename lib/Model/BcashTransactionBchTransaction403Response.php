...
/**
 * bcashTransactionBchTransaction_403_response Model
 *
 ...
 * bcashTransactionBchTransaction_403_response Model
 */
class BcashTransactionBchTransaction403Response extends AbstractModel {

    public const _D = null;
    protected static $_name = "bcashTransactionBchTransaction_403_response";
     ...
     * Set error_code
     * 
     * @param string $error_code blockchain.error.code
     ...
     * Set message
     * 
     * @param string $message ${error.message} Code: ${error.code}
     * @throws \InvalidArgumentException
     * @return $this
     */
