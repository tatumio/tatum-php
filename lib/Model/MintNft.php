...
class MintNft extends AbstractModel {
    ...
    public function __construct(array $data = []) {
        foreach(["chain"=>null, "to"=>null, "contract_address"=>null, "token_id"=>null, "url"=>null, "from_private_key"=>null, "erc20"=>null, "provenance"=>null, "author_addresses"=>null, "cashback_values"=>null, "fixed_values"=>null, "nonce"=>null, "fee"=>null] as $k => $v) {
    ...
    public function setChain(string $chain) {
        ...
        if (!in_array($chain, $allowed, true)) {
            throw new IAE(sprintf("MintNft.setChain: chain invalid value '%s', must be one of '%s'", $chain, implode("', '", $allowed)));
        }
    ...
    public function setTo(string $to) {
        if ((mb_strlen($to) > 42)) {
            throw new IAE('MintNft.setTo: $to length must be <= 42');
        }
        if ((mb_strlen($to) < 42)) {
            throw new IAE('MintNft.setTo: $to length must be >= 42');
        }
    ...
    public function setContractAddress(string $contract_address) {
        if ((mb_strlen($contract_address) > 42)) {
            throw new IAE('MintNft.setContractAddress: $contract_address length must be <= 42');
        }
        if ((mb_strlen($contract_address) < 42)) {
            throw new IAE('MintNft.setContractAddress: $contract_address length must be >= 42');
        }
    ...
    public function setTokenId(string $token_id) {
        if ((mb_strlen($token_id) > 78)) {
            throw new IAE('MintNft.setTokenId: $token_id length must be <= 78');
        }
    ...
    public function setUrl(string $url) {
        if ((mb_strlen($url) > 256)) {
            throw new IAE('MintNft.setUrl: $url length must be <= 256');
        }
        $this->_data['url'] = $url;
    ...
    public function setFromPrivateKey(string $from_private_key) {
        if ((mb_strlen($from_private_key) > 66)) {
            throw new IAE('MintNft.setFromPrivateKey: $from_private_key length must be <= 66');
        }
        if ((mb_strlen($from_private_key) < 66)) {
            throw new IAE('MintNft.setFromPrivateKey: $from_private_key length must be >= 66');
        }
    ...
    public function setErc20(?string $erc20) {
        if (!is_null($erc20) && (mb_strlen($erc20) > 42)) {
            throw new IAE('MintNft.setErc20: $erc20 length must be <= 42');
        }
        if (!is_null($erc20) && (mb_strlen($erc20) < 42)) {
            throw new IAE('MintNft.setErc20: $erc20 length must be >= 42');
        }
    ...
    public function setNonce(?float $nonce) {
        if (!is_null($nonce) && ($nonce < 0)) {
            throw new IAE('MintNft.setNonce: $nonce must be >=0');
        }
