 ...
 * MintMultiTokenKMS Model
 */
class MintMultiTokenKMS extends AbstractModel {
    ...
    protected static $_name = "MintMultiTokenKMS";
    ...
    public function __construct(array $data = []) {
        foreach(["chain"=>null, "token_id"=>null, "to"=>null, "contract_address"=>null, "amount"=>null, "data"=>null, "index"=>null, "signature_id"=>null, "nonce"=>null, "fee"=>null] as $k => $v) {
    ...
    public function setChain(string $chain) {
        ...
        if (!in_array($chain, $allowed, true)) {
            throw new IAE(sprintf("MintMultiTokenKMS.setChain: chain invalid value '%s', must be one of '%s'", $chain, implode("', '", $allowed)));
        }
    ...
    public function setTokenId(string $token_id) {
        if ((mb_strlen($token_id) > 32)) {
            throw new IAE('MintMultiTokenKMS.setTokenId: $token_id length must be <= 32');
        }
    ...
    public function setTo(string $to) {
        if ((mb_strlen($to) > 42)) {
            throw new IAE('MintMultiTokenKMS.setTo: $to length must be <= 42');
        }
        if ((mb_strlen($to) < 42)) {
            throw new IAE('MintMultiTokenKMS.setTo: $to length must be >= 42');
        }
    ...
    public function setContractAddress(string $contract_address) {
        if ((mb_strlen($contract_address) > 42)) {
            throw new IAE('MintMultiTokenKMS.setContractAddress: $contract_address length must be <= 42');
        }
        if ((mb_strlen($contract_address) < 42)) {
            throw new IAE('MintMultiTokenKMS.setContractAddress: $contract_address length must be >= 42');
        }
    ...
    public function setAmount(string $amount) {
        if ((mb_strlen($amount) > 32)) {
            throw new IAE('MintMultiTokenKMS.setAmount: $amount length must be <= 32');
        }
    ...
    public function setIndex(?float $index) {
        if (!is_null($index) && ($index < 0)) {
            throw new IAE('MintMultiTokenKMS.setIndex: $index must be >=0');
        }
    ...
    public function setNonce(?float $nonce) {
        if (!is_null($nonce) && ($nonce < 0)) {
            throw new IAE('MintMultiTokenKMS.setNonce: $nonce must be >=0');
        }
