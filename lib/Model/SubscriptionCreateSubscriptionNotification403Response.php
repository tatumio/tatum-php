...
/**
 * subscriptionCreateSubscriptionNotification_403_response Model
 *
 ...
 * subscriptionCreateSubscriptionNotification_403_response Model
 */
class SubscriptionCreateSubscriptionNotification403Response extends AbstractModel {

    public const _D = null;
    protected static $_name = "subscriptionCreateSubscriptionNotification_403_response";
     ...
     * Set error_code
     * 
     * @param string $error_code subscription.attr.pending.invalid
     ...
     * Set message
     * 
     * @param string $message Invalid subscription attribute 'id' or 'url'.
     * @throws \InvalidArgumentException
     * @return $this
     */
