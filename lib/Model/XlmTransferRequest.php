 ...
 * XlmTransfer_request Model
 */
class XlmTransferRequest extends AbstractModel {
    ...
    public function setSenderAccountId(string $sender_account_id) {
        if ((mb_strlen($sender_account_id) > 24)) {
            throw new IAE('XlmTransferRequest.setSenderAccountId: $sender_account_id length must be <= 24');
        }
        if ((mb_strlen($sender_account_id) < 24)) {
            throw new IAE('XlmTransferRequest.setSenderAccountId: $sender_account_id length must be >= 24');
        }
    ...
    public function setFromAccount(string $from_account) {
        if ((mb_strlen($from_account) > 56)) {
            throw new IAE('XlmTransferRequest.setFromAccount: $from_account length must be <= 56');
        }
        if ((mb_strlen($from_account) < 56)) {
            throw new IAE('XlmTransferRequest.setFromAccount: $from_account length must be >= 56');
        }
    ...
    public function setAddress(string $address) {
        if ((mb_strlen($address) > 56)) {
            throw new IAE('XlmTransferRequest.setAddress: $address length must be <= 56');
        }
        if ((mb_strlen($address) < 56)) {
            throw new IAE('XlmTransferRequest.setAddress: $address length must be >= 56');
        }
    ...
    public function setAmount(string $amount) {
        if ((mb_strlen($amount) > 38)) {
            throw new IAE('XlmTransferRequest.setAmount: $amount length must be <= 38');
        }
        if ((!preg_match("/^[+]?((\\d+(\\.\\d*)?)|(\\.\\d+))$/", $amount))) {
            throw new IAE('XlmTransferRequest.setAmount: $amount must match /^[+]?((\\d+(\\.\\d*)?)|(\\.\\d+))$/, ' . var_export($amount, true) . ' given');
        }
    ...
    public function setSecret(string $secret) {
        if ((mb_strlen($secret) > 56)) {
            throw new IAE('XlmTransferRequest.setSecret: $secret length must be <= 56');
        }
        if ((mb_strlen($secret) < 56)) {
            throw new IAE('XlmTransferRequest.setSecret: $secret length must be >= 56');
        }
    ...
    public function setAttr(?string $attr) {
        if (!is_null($attr) && (mb_strlen($attr) > 64)) {
            throw new IAE('XlmTransferRequest.setAttr: $attr length must be <= 64');
        }
        if (!is_null($attr) && (!preg_match("/^[ -~]{0,64}$/", $attr))) {
            throw new IAE('XlmTransferRequest.setAttr: $attr must match /^[ -~]{0,64}$/, ' . var_export($attr, true) . ' given');
        }
    ...
    public function setPaymentId(?string $payment_id) {
        if (!is_null($payment_id) && (mb_strlen($payment_id) > 100)) {
            throw new IAE('XlmTransferRequest.setPaymentId: $payment_id length must be <= 100');
        }
        if (!is_null($payment_id) && (mb_strlen($payment_id) < 1)) {
            throw new IAE('XlmTransferRequest.setPaymentId: $payment_id length must be >= 1');
        }
    ...
    public function setSenderNote(?string $sender_note) {
        if (!is_null($sender_note) && (mb_strlen($sender_note) > 500)) {
            throw new IAE('XlmTransferRequest.setSenderNote: $sender_note length must be <= 500');
        }
        if (!is_null($sender_note) && (mb_strlen($sender_note) < 1)) {
            throw new IAE('XlmTransferRequest.setSenderNote: $sender_note length must be >= 1');
        }
