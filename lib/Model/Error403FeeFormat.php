 ...
 * Error403FeeFormat Model
 */
class Error403FeeFormat extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403FeeFormat";
     ...
     * Set error_code
     * 
     * @param string $error_code fee.format
     ...
     * Set message
     * 
     * @param string $message Fee has incorrect format.
     * @throws \InvalidArgumentException
     * @return $this
     */
