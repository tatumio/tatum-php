...
class UpdateMarketplaceSolanaKMS extends AbstractModel {
    ...
    public function __construct(array $data = []) {
        foreach(["chain"=>null, "contract_address"=>null, "marketplace_fee"=>null, "from"=>null, "treasury_withdrawal_destination"=>null, "fee_withdrawal_destination"=>null, "requires_sign_off"=>null, "can_change_sale_price"=>null, "signature_id"=>null] as $k => $v) {
    ...
    public function setChain(string $chain) {
        ...
        if (!in_array($chain, $allowed, true)) {
            throw new IAE(sprintf("UpdateMarketplaceSolanaKMS.setChain: chain invalid value '%s', must be one of '%s'", $chain, implode("', '", $allowed)));
        }
    ...
    public function setContractAddress(string $contract_address) {
        if ((mb_strlen($contract_address) > 44)) {
            throw new IAE('UpdateMarketplaceSolanaKMS.setContractAddress: $contract_address length must be <= 44');
        }
        if ((mb_strlen($contract_address) < 44)) {
            throw new IAE('UpdateMarketplaceSolanaKMS.setContractAddress: $contract_address length must be >= 44');
        }
    ...
    public function setMarketplaceFee(?float $marketplace_fee) {
        if (!is_null($marketplace_fee) && ($marketplace_fee > 10000)) {
            throw new IAE('UpdateMarketplaceSolanaKMS.setMarketplaceFee: $marketplace_fee must be <=10000');
        }
        if (!is_null($marketplace_fee) && ($marketplace_fee < 0)) {
            throw new IAE('UpdateMarketplaceSolanaKMS.setMarketplaceFee: $marketplace_fee must be >=0');
        }
    ...
    public function setFrom(string $from) {
        if ((mb_strlen($from) > 44)) {
            throw new IAE('UpdateMarketplaceSolanaKMS.setFrom: $from length must be <= 44');
        }
        if ((mb_strlen($from) < 44)) {
            throw new IAE('UpdateMarketplaceSolanaKMS.setFrom: $from length must be >= 44');
        }
    ...
    public function setTreasuryWithdrawalDestination(?string $treasury_withdrawal_destination) {
        if (!is_null($treasury_withdrawal_destination) && (mb_strlen($treasury_withdrawal_destination) > 44)) {
            throw new IAE('UpdateMarketplaceSolanaKMS.setTreasuryWithdrawalDestination: $treasury_withdrawal_destination length must be <= 44');
        }
        if (!is_null($treasury_withdrawal_destination) && (mb_strlen($treasury_withdrawal_destination) < 43)) {
            throw new IAE('UpdateMarketplaceSolanaKMS.setTreasuryWithdrawalDestination: $treasury_withdrawal_destination length must be >= 43');
        }
    ...
    public function setFeeWithdrawalDestination(?string $fee_withdrawal_destination) {
        if (!is_null($fee_withdrawal_destination) && (mb_strlen($fee_withdrawal_destination) > 44)) {
            throw new IAE('UpdateMarketplaceSolanaKMS.setFeeWithdrawalDestination: $fee_withdrawal_destination length must be <= 44');
        }
        if (!is_null($fee_withdrawal_destination) && (mb_strlen($fee_withdrawal_destination) < 43)) {
            throw new IAE('UpdateMarketplaceSolanaKMS.setFeeWithdrawalDestination: $fee_withdrawal_destination length must be >= 43');
        }
