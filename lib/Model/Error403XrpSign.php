 ...
 * Error403XrpSign Model
 */
class Error403XrpSign extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403XrpSign";
     ...
     * Set error_code
     * 
     * @param string $error_code xrp.sign.failed
     ...
     * Set message
     * 
     * @param string $message Unable to sign tx. ${error}
     * @throws \InvalidArgumentException
     * @return $this
     */
