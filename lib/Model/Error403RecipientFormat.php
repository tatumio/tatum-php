 ...
 * Error403RecipientFormat Model
 */
class Error403RecipientFormat extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403RecipientFormat";
     ...
     * Set error_code
     * 
     * @param string $error_code withdrawal.recipient.format
     ...
     * Set message
     * 
     * @param string $message Recipient blockchain address has incorrect format.
     * @throws \InvalidArgumentException
     * @return $this
     */
