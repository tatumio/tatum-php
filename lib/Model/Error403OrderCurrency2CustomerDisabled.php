...
/**
 * Error403OrderCurrency2CustomerDisabled Model
 *
 ...
 * Error403OrderCurrency2CustomerDisabled Model
 */
class Error403OrderCurrency2CustomerDisabled extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403OrderCurrency2CustomerDisabled";
     ...
     * Set error_code
     * 
     * @param string $error_code trade.currency2AccountId.customer.disabled
     ...
     * Set message
     * 
     * @param string $message Currency2 account's customer ${currency2Account.customerId} is disabled, unable to perform exchange trade.
     * @throws \InvalidArgumentException
     * @return $this
     */
