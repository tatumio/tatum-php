 ...
 * Error403AmountFormat Model
 */
class Error403AmountFormat extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403AmountFormat";
     ...
     * Set error_code
     * 
     * @param string $error_code amount.format
     ...
     * Set message
     * 
     * @param string $message Amount has incorrect format.
     * @throws \InvalidArgumentException
     * @return $this
     */
