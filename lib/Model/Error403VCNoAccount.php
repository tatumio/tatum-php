 ...
 * Error403VCNoAccount Model
 */
class Error403VCNoAccount extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403VCNoAccount";
     ...
     * Set error_code
     * 
     * @param string $error_code virtual.account.notValid
     ...
     * Set message
     * 
     * @param string $message Unable to perform operation on virtual currency, account does not exists.
     * @throws \InvalidArgumentException
     * @return $this
     */
