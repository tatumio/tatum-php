...
/**
 * createCurrency_403_response Model
 *
 ...
 * createCurrency_403_response Model
 */
class CreateCurrency403Response extends AbstractModel {

    public const _D = null;
    protected static $_name = "createCurrency_403_response";
     ...
     * Set error_code
     * 
     * @param string $error_code virtual.creation.error
     ...
     * Set message
     * 
     * @param string $message It is not possible to create virtual currency.
     * @throws \InvalidArgumentException
     * @return $this
     */
