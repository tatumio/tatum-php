 ...
 * Error403WithdrawalVC Model
 */
class Error403WithdrawalVC extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403WithdrawalVC";
     ...
     * Set error_code
     * 
     * @param string $error_code withdrawal.account.virtual
     ...
     * Set message
     * 
     * @param string $message Sender account cannot be virtual.
     * @throws \InvalidArgumentException
     * @return $this
     */
