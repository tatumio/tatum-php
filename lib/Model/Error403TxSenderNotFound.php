...
/**
 * Error403TxSenderNotFound Model
 *
 ...
 * Error403TxSenderNotFound Model
 */
class Error403TxSenderNotFound extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403TxSenderNotFound";
     ...
     * Set error_code
     * 
     * @param string $error_code senderAccount.not.exists
     ...
     * Set message
     * 
     * @param string $message Unable to find sender account ${transaction.senderAccountId}.
     * @throws \InvalidArgumentException
     * @return $this
     */
