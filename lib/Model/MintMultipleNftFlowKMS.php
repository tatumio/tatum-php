...
class MintMultipleNftFlowKMS extends AbstractModel {
    ...
    public function setChain(string $chain) {
        ...
        if (!in_array($chain, $allowed, true)) {
            throw new IAE(sprintf("MintMultipleNftFlowKMS.setChain: chain invalid value '%s', must be one of '%s'", $chain, implode("', '", $allowed)));
        }
    ...
    public function setContractAddress(string $contract_address) {
        if ((mb_strlen($contract_address) > 36)) {
            throw new IAE('MintMultipleNftFlowKMS.setContractAddress: $contract_address length must be <= 36');
        }
        if ((mb_strlen($contract_address) < 36)) {
            throw new IAE('MintMultipleNftFlowKMS.setContractAddress: $contract_address length must be >= 36');
        }
    ...
    public function setAccount(string $account) {
        if ((mb_strlen($account) > 18)) {
            throw new IAE('MintMultipleNftFlowKMS.setAccount: $account length must be <= 18');
        }
        if ((mb_strlen($account) < 18)) {
            throw new IAE('MintMultipleNftFlowKMS.setAccount: $account length must be >= 18');
        }
    ...
    public function setIndex(?int $index) {
        if (!is_null($index) && ($index > 2147483647)) {
            throw new IAE('MintMultipleNftFlowKMS.setIndex: $index must be <=2147483647');
        }
