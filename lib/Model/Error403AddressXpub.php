 ...
 * Error403AddressXpub Model
 */
class Error403AddressXpub extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403AddressXpub";
     ...
     * Set error_code
     * 
     * @param string $error_code account.xpub.present
     ...
     * Set message
     * 
     * @param string $message Xpub assigned to account, it is not possible to assign address. Use generateAddress method instead.
     * @throws \InvalidArgumentException
     * @return $this
     */
