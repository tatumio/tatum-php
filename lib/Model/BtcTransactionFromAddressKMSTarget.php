...
/**
 * BtcTransactionFromAddressKMSTarget Model
 *
 ...
 * BtcTransactionFromAddressKMSTarget Model
 */
class BtcTransactionFromAddressKMSTarget extends AbstractModel {

    public const DISCRIMINATOR = null;
    protected static $_name = "BtcTransactionFromAddressKMSTarget";
    ...
    public function setValue(float $value) {
        if (($value < 0)) {
            throw new IAE('BtcTransactionFromAddressKMSTarget.setValue: $value must be >=0');
        }
