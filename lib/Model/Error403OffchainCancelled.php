...
/**
 * Error403OffchainCancelled Model
 *
 ...
 * Error403OffchainCancelled Model
 */
class Error403OffchainCancelled extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403OffchainCancelled";
     ...
     * Set error_code
     * 
     * @param string $error_code withdrawal.prepare.failed
     ...
     * Set message
     * 
     * @param string $message Unable to prepare transaction, withdrawal cancelled.
     * @throws \InvalidArgumentException
     * @return $this
     */
