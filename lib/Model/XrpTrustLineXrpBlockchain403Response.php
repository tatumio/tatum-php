...
/**
 * xrpTrustLineXrpBlockchain_403_response Model
 *
 ...
 * xrpTrustLineXrpBlockchain_403_response Model
 */
class XrpTrustLineXrpBlockchain403Response extends AbstractModel {

    public const _D = null;
    protected static $_name = "xrpTrustLineXrpBlockchain_403_response";
     ...
     * Set error_code
     * 
     * @param string $error_code xrp.broadcast.failed
     ...
     * Set message
     * 
     * @param string $message Xrp submit tx failed. ${error}
     * @throws \InvalidArgumentException
     * @return $this
     */
