...
/**
 * Error403OrderCurrency2NotFound Model
 *
 ...
 * Error403OrderCurrency2NotFound Model
 */
class Error403OrderCurrency2NotFound extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403OrderCurrency2NotFound";
     ...
     * Set error_code
     * 
     * @param string $error_code trade.currency2AccountId.not.exists
     ...
     * Set message
     * 
     * @param string $message Unable to find currency2 account ${trade.currency2AccountId}.
     * @throws \InvalidArgumentException
     * @return $this
     */
