 ...
 * Error403VCTxFailed Model
 */
class Error403VCTxFailed extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403VCTxFailed";
     ...
     * Set error_code
     * 
     * @param string $error_code virtual.tx.failed
     ...
     * Set message
     * 
     * @param string $message Unable to perform operation on virtual currency, impossible to store transaction.
     * @throws \InvalidArgumentException
     * @return $this
     */
