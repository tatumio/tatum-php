 ...
 * Error403BcashBroadcast Model
 */
class Error403BcashBroadcast extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403BcashBroadcast";
     ...
     * Set error_code
     * 
     * @param string $error_code bch.broadcast.failed
     ...
     * Set message
     * 
     * @param string $message Unable to broadcast transaction. Error from blockchain: ${error}
     * @throws \InvalidArgumentException
     * @return $this
     */
