...
/**
 * CallXdcSmartContractMethodKMS Model
 *
 ...
 * CallXdcSmartContractMethodKMS Model
 */
class CallXdcSmartContractMethodKMS extends AbstractModel {

    public const DISCRIMINATOR = null;
    protected static $_name = "CallXdcSmartContractMethodKMS";
    ...
    public function setContractAddress(string $contract_address) {
        if ((mb_strlen($contract_address) > 43)) {
            throw new IAE('CallXdcSmartContractMethodKMS.setContractAddress: $contract_address length must be <= 43');
        }
        if ((mb_strlen($contract_address) < 42)) {
            throw new IAE('CallXdcSmartContractMethodKMS.setContractAddress: $contract_address length must be >= 42');
        }
    ...
    public function setMethodName(string $method_name) {
        if ((mb_strlen($method_name) > 500)) {
            throw new IAE('CallXdcSmartContractMethodKMS.setMethodName: $method_name length must be <= 500');
        }
        if ((mb_strlen($method_name) < 1)) {
            throw new IAE('CallXdcSmartContractMethodKMS.setMethodName: $method_name length must be >= 1');
        }
    ...
    public function setIndex(?float $index) {
        if (!is_null($index) && ($index < 0)) {
            throw new IAE('CallXdcSmartContractMethodKMS.setIndex: $index must be >=0');
        }
    ...
    public function setNonce(?float $nonce) {
        if (!is_null($nonce) && ($nonce < 0)) {
            throw new IAE('CallXdcSmartContractMethodKMS.setNonce: $nonce must be >=0');
        }
