...
/**
 * Error403AccountCustomerInactive Model
 *
 ...
 * Error403AccountCustomerInactive Model
 */
class Error403AccountCustomerInactive extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403AccountCustomerInactive";
     ...
     * Set error_code
     * 
     * @param string $error_code account.customer.inactive
     ...
     * Set message
     * 
     * @param string $message Unable to activate account, customer inactive.
     * @throws \InvalidArgumentException
     * @return $this
     */
