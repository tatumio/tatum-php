 ...
 * Error403KMSNotExists Model
 */
class Error403KMSNotExists extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403KMSNotExists";
     ...
     * Set error_code
     * 
     * @param string $error_code kms.missing
     ...
     * Set message
     * 
     * @param string $message No such KMS signature with id '{id}'.
     * @throws \InvalidArgumentException
     * @return $this
     */
