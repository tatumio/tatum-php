...
/**
 * Error403BtcMnemonicTxFailed Model
 *
 ...
 * Error403BtcMnemonicTxFailed Model
 */
class Error403BtcMnemonicTxFailed extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403BtcMnemonicTxFailed";
     ...
     * Set error_code
     * 
     * @param string $error_code transaction.preparation.failed
     ...
     * Set message
     * 
     * @param string $message Impossible to prepare transaction. Either mnemonic or keyPair and attr must be present.
     * @throws \InvalidArgumentException
     * @return $this
     */
