...
/**
 * Error403OrderCurrency1CustomerDisabled Model
 *
 ...
 * Error403OrderCurrency1CustomerDisabled Model
 */
class Error403OrderCurrency1CustomerDisabled extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403OrderCurrency1CustomerDisabled";
     ...
     * Set error_code
     * 
     * @param string $error_code trade.currency1AccountId.customer.disabled
     ...
     * Set message
     * 
     * @param string $message Currency1 account's customer ${currency1Account.customerId} is disabled, unable to perform exchange trade.
     * @throws \InvalidArgumentException
     * @return $this
     */
