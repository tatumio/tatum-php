...
/**
 * offchainLitecoinTransferLtcMnemonic_403_response Model
 *
 ...
 * offchainLitecoinTransferLtcMnemonic_403_response Model
 */
class OffchainLitecoinTransferLtcMnemonic403Response extends AbstractModel {

    public const _D = null;
    protected static $_name = "offchainLitecoinTransferLtcMnemonic_403_response";
     ...
     * Set error_code
     * 
     * @param string $error_code withdrawal.pending
     ...
     * Set message
     * 
     * @param string $message Unable to prepare withdrawal, last withdrawal with id ${id} is not yet processed by blockchain.
     * @throws \InvalidArgumentException
     * @return $this
     */
