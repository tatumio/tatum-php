...
/**
 * Error403OrderCurrency1Frozen Model
 *
 ...
 * Error403OrderCurrency1Frozen Model
 */
class Error403OrderCurrency1Frozen extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403OrderCurrency1Frozen";
     ...
     * Set error_code
     * 
     * @param string $error_code trade.currency1AccountId.frozen
     ...
     * Set message
     * 
     * @param string $message Currency1 account ${trade.currency1AccountId} is frozen, unable to perform trade.
     * @throws \InvalidArgumentException
     * @return $this
     */
