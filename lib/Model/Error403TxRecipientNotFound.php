...
/**
 * Error403TxRecipientNotFound Model
 *
 ...
 * Error403TxRecipientNotFound Model
 */
class Error403TxRecipientNotFound extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403TxRecipientNotFound";
     ...
     * Set error_code
     * 
     * @param string $error_code recipientAccount.not.exists
     ...
     * Set message
     * 
     * @param string $message Unable to find recipient account ${transaction.recipientAccountId}.
     * @throws \InvalidArgumentException
     * @return $this
     */
