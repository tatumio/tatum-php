...
/**
 * Error403OrderCurrency2Pair Model
 *
 ...
 * Error403OrderCurrency2Pair Model
 */
class Error403OrderCurrency2Pair extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403OrderCurrency2Pair";
     ...
     * Set error_code
     * 
     * @param string $error_code trade.currency2.pair
     ...
     * Set message
     * 
     * @param string $message Incompatible currencies for currency2 account ${trade.currency2AccountId} and trading pair.
     * @throws \InvalidArgumentException
     * @return $this
     */
