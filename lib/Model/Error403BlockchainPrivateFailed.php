...
/**
 * Error403BlockchainPrivateFailed Model
 *
 ...
 * Error403BlockchainPrivateFailed Model
 */
class Error403BlockchainPrivateFailed extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403BlockchainPrivateFailed";
     ...
     * Set error_code
     * 
     * @param string $error_code key.generation.failed.wrong.mnemonic
     ...
     * Set message
     * 
     * @param string $message Unable to generate address, wrong mnemonic and index.
     * @throws \InvalidArgumentException
     * @return $this
     */
