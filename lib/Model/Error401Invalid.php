 ...
 * Error401Invalid Model
 */
class Error401Invalid extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error401Invalid";
     ...
     * Set error_code
     * 
     * @param string $error_code subscription.invalid
     ...
     * Set message
     * 
     * @param string $message Unable to find valid subscription for '${apiKey}'
     * @throws \InvalidArgumentException
     * @return $this
     */
