 ...
 * Error403TxCurrency Model
 */
class Error403TxCurrency extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403TxCurrency";
     ...
     * Set error_code
     * 
     * @param string $error_code transaction.currency.incompatible
     ...
     * Set message
     * 
     * @param string $message Incompatible currencies for sender account ${transaction.senderAccountId} and recipient account ${transaction.recipientAccountId}.
     * @throws \InvalidArgumentException
     * @return $this
     */
