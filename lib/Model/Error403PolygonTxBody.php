 ...
 * Error403PolygonTxBody Model
 */
class Error403PolygonTxBody extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403PolygonTxBody";
     ...
     * Set error_code
     * 
     * @param string $error_code polygon.transaction.body
     ...
     * Set message
     * 
     * @param string $message Either currency, or tokenAddress must be defined.
     * @throws \InvalidArgumentException
     * @return $this
     */
