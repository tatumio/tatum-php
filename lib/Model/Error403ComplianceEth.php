 ...
 * Error403ComplianceEth Model
 */
class Error403ComplianceEth extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403ComplianceEth";
     ...
     * Set error_code
     * 
     * @param string $error_code compliance.country.eth.not.supported
     ...
     * Set message
     * 
     * @param string $message Customer country not supported for ETH.
     * @throws \InvalidArgumentException
     * @return $this
     */
