...
/**
 * Error403OffchainNotSupported Model
 *
 ...
 * Error403OffchainNotSupported Model
 */
class Error403OffchainNotSupported extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403OffchainNotSupported";
     ...
     * Set error_code
     * 
     * @param string $error_code offchain.not.supported
     ...
     * Set message
     * 
     * @param string $message Offchain not supported for account with ${account.currency} currency.
     * @throws \InvalidArgumentException
     * @return $this
     */
