...
/**
 * Error403PolygonErc20TxSign Model
 *
 ...
 * Error403PolygonErc20TxSign Model
 */
class Error403PolygonErc20TxSign extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403PolygonErc20TxSign";
     ...
     * Set error_code
     * 
     * @param string $error_code polygon.bep20.sign
     ...
     * Set message
     * 
     * @param string $message Unable to sign transaction for contract creation. ${error}
     * @throws \InvalidArgumentException
     * @return $this
     */
