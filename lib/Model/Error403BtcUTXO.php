 ...
 * Error403BtcUTXO Model
 */
class Error403BtcUTXO extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403BtcUTXO";
     ...
     * Set error_code
     * 
     * @param string $error_code tx.hash.index.spent
     ...
     * Set message
     * 
     * @param string $message No such UTXO for transaction and index.
     * @throws \InvalidArgumentException
     * @return $this
     */
