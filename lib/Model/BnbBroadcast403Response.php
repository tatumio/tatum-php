...
/**
 * BnbBroadcast_403_response Model
 *
 ...
 * BnbBroadcast_403_response Model
 */
class BnbBroadcast403Response extends AbstractModel {

    public const _D = null;
    protected static $_name = "BnbBroadcast_403_response";
     ...
     * Set error_code
     * 
     * @param string $error_code bnb.broadcast.failed.tx.state
     ...
     * Set message
     * 
     * @param string $message Unable to broadcast BNB transaction, tx ${hash} state not OK.
     * @throws \InvalidArgumentException
     * @return $this
     */
