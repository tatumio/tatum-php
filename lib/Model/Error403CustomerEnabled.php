 ...
 * Error403CustomerEnabled Model
 */
class Error403CustomerEnabled extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403CustomerEnabled";
     ...
     * Set error_code
     * 
     * @param string $error_code customer.enabled
     ...
     * Set message
     * 
     * @param string $message Unable to enable enabled customer.
     * @throws \InvalidArgumentException
     * @return $this
     */
