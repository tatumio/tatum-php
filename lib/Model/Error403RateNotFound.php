 ...
 * Error403RateNotFound Model
 */
class Error403RateNotFound extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403RateNotFound";
     ...
     * Set error_code
     * 
     * @param string $error_code rate.not.found
     ...
     * Set message
     * 
     * @param string $message No such currency rate.
     * @throws \InvalidArgumentException
     * @return $this
     */
