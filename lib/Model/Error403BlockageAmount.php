 ...
 * Error403BlockageAmount Model
 */
class Error403BlockageAmount extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403BlockageAmount";
     ...
     * Set error_code
     * 
     * @param string $error_code blockage.amount.exceeded
     ...
     * Set message
     * 
     * @param string $message Amount to transfer is greater then amount of the blockage.
     * @throws \InvalidArgumentException
     * @return $this
     */
