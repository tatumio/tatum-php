 ...
 * CreateAuction_request Model
 */
class CreateAuctionRequest extends AbstractModel {
    ...
    protected static $_name = "CreateAuction_request";
    ...
    public function __construct(array $data = []) {
        foreach(["chain"=>null, "contract_address"=>null, "nft_address"=>null, "seller"=>null, "erc20_address"=>null, "id"=>null, "amount"=>null, "token_id"=>null, "ended_at"=>null, "is_erc721"=>null, "from_private_key"=>null, "nonce"=>null, "fee"=>null, "signature_id"=>null, "index"=>null, "fee_currency"=>null] as $k => $v) {
    ...
    public function setChain(string $chain) {
        ...
        if (!in_array($chain, $allowed, true)) {
            throw new IAE(sprintf("CreateAuctionRequest.setChain: chain invalid value '%s', must be one of '%s'", $chain, implode("', '", $allowed)));
        }
    ...
    public function setContractAddress(string $contract_address) {
        if ((mb_strlen($contract_address) > 42)) {
            throw new IAE('CreateAuctionRequest.setContractAddress: $contract_address length must be <= 42');
        }
        if ((mb_strlen($contract_address) < 42)) {
            throw new IAE('CreateAuctionRequest.setContractAddress: $contract_address length must be >= 42');
        }
    ...
    public function setNftAddress(string $nft_address) {
        if ((mb_strlen($nft_address) > 42)) {
            throw new IAE('CreateAuctionRequest.setNftAddress: $nft_address length must be <= 42');
        }
        if ((mb_strlen($nft_address) < 42)) {
            throw new IAE('CreateAuctionRequest.setNftAddress: $nft_address length must be >= 42');
        }
    ...
    public function setSeller(string $seller) {
        if ((mb_strlen($seller) > 42)) {
            throw new IAE('CreateAuctionRequest.setSeller: $seller length must be <= 42');
        }
        if ((mb_strlen($seller) < 42)) {
            throw new IAE('CreateAuctionRequest.setSeller: $seller length must be >= 42');
        }
    ...
    public function setErc20Address(?string $erc20_address) {
        if (!is_null($erc20_address) && (mb_strlen($erc20_address) > 42)) {
            throw new IAE('CreateAuctionRequest.setErc20Address: $erc20_address length must be <= 42');
        }
        if (!is_null($erc20_address) && (mb_strlen($erc20_address) < 42)) {
            throw new IAE('CreateAuctionRequest.setErc20Address: $erc20_address length must be >= 42');
        }
    ...
    public function setId(string $id) {
        if ((mb_strlen($id) > 200)) {
            throw new IAE('CreateAuctionRequest.setId: $id length must be <= 200');
        }
        if ((mb_strlen($id) < 1)) {
            throw new IAE('CreateAuctionRequest.setId: $id length must be >= 1');
        }
        $this->_data['id'] = $id;
    ...
    public function setAmount(?string $amount) {
        if (!is_null($amount) && (!preg_match("/^[+]?((\\d+(\\.\\d*)?)|(\\.\\d+))$/", $amount))) {
            throw new IAE('CreateAuctionRequest.setAmount: $amount must match /^[+]?((\\d+(\\.\\d*)?)|(\\.\\d+))$/, ' . var_export($amount, true) . ' given');
        }
    ...
    public function setTokenId(string $token_id) {
        if ((mb_strlen($token_id) > 256)) {
            throw new IAE('CreateAuctionRequest.setTokenId: $token_id length must be <= 256');
        }
    ...
    public function setEndedAt(float $ended_at) {
        if (($ended_at < 0)) {
            throw new IAE('CreateAuctionRequest.setEndedAt: $ended_at must be >=0');
        }
    ...
    public function setFromPrivateKey(string $from_private_key) {
        if ((mb_strlen($from_private_key) > 66)) {
            throw new IAE('CreateAuctionRequest.setFromPrivateKey: $from_private_key length must be <= 66');
        }
        if ((mb_strlen($from_private_key) < 66)) {
            throw new IAE('CreateAuctionRequest.setFromPrivateKey: $from_private_key length must be >= 66');
        }
    ...
    public function setIndex(?float $index) {
        if (!is_null($index) && ($index < 0)) {
            throw new IAE('CreateAuctionRequest.setIndex: $index must be >=0');
        }
    ...
    public function setFeeCurrency(string $fee_currency) {
        ...
        if (!in_array($fee_currency, $allowed, true)) {
            throw new IAE(sprintf("CreateAuctionRequest.setFeeCurrency: fee_currency invalid value '%s', must be one of '%s'", $fee_currency, implode("', '", $allowed)));
        }
