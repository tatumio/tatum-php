...
/**
 * Error403TxSenderCustomerDisabled Model
 *
 ...
 * Error403TxSenderCustomerDisabled Model
 */
class Error403TxSenderCustomerDisabled extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403TxSenderCustomerDisabled";
     ...
     * Set error_code
     * 
     * @param string $error_code senderAccount.customer.disabled
     ...
     * Set message
     * 
     * @param string $message Sender accounts customer ${senderAccount.customerId} is disabled, unable to perform payment.
     * @throws \InvalidArgumentException
     * @return $this
     */
