 ...
 * TronCreateTrc10_request Model
 */
class TronCreateTrc10Request extends AbstractModel {

    public const DISCRIMINATOR = null;
    protected static $_name = "TronCreateTrc10_request";
    ...
    public function __construct(array $data = []) {
        foreach(["from_private_key"=>null, "recipient"=>null, "name"=>null, "abbreviation"=>null, "description"=>null, "url"=>null, "total_supply"=>null, "decimals"=>null, "from"=>null, "signature_id"=>null, "index"=>null] as $k => $v) {
    ...
    public function setFromPrivateKey(string $from_private_key) {
        if ((mb_strlen($from_private_key) > 64)) {
            throw new IAE('TronCreateTrc10Request.setFromPrivateKey: $from_private_key length must be <= 64');
        }
        if ((mb_strlen($from_private_key) < 64)) {
            throw new IAE('TronCreateTrc10Request.setFromPrivateKey: $from_private_key length must be >= 64');
        }
    ...
    public function setRecipient(string $recipient) {
        if ((mb_strlen($recipient) > 34)) {
            throw new IAE('TronCreateTrc10Request.setRecipient: $recipient length must be <= 34');
        }
        if ((mb_strlen($recipient) < 34)) {
            throw new IAE('TronCreateTrc10Request.setRecipient: $recipient length must be >= 34');
        }
    ...
    public function setName(string $name) {
        if ((mb_strlen($name) > 100)) {
            throw new IAE('TronCreateTrc10Request.setName: $name length must be <= 100');
        }
        if ((mb_strlen($name) < 1)) {
            throw new IAE('TronCreateTrc10Request.setName: $name length must be >= 1');
        }
    ...
    public function setAbbreviation(string $abbreviation) {
        if ((mb_strlen($abbreviation) > 100)) {
            throw new IAE('TronCreateTrc10Request.setAbbreviation: $abbreviation length must be <= 100');
        }
        if ((mb_strlen($abbreviation) < 1)) {
            throw new IAE('TronCreateTrc10Request.setAbbreviation: $abbreviation length must be >= 1');
        }
    ...
    public function setDescription(string $description) {
        if ((mb_strlen($description) > 100)) {
            throw new IAE('TronCreateTrc10Request.setDescription: $description length must be <= 100');
        }
        if ((mb_strlen($description) < 1)) {
            throw new IAE('TronCreateTrc10Request.setDescription: $description length must be >= 1');
        }
    ...
    public function setUrl(string $url) {
        if ((mb_strlen($url) > 100)) {
            throw new IAE('TronCreateTrc10Request.setUrl: $url length must be <= 100');
        }
        if ((mb_strlen($url) < 1)) {
            throw new IAE('TronCreateTrc10Request.setUrl: $url length must be >= 1');
        }
        $this->_data['url'] = $url;
    ...
    public function setTotalSupply(float $total_supply) {
        if (($total_supply < 0)) {
            throw new IAE('TronCreateTrc10Request.setTotalSupply: $total_supply must be >=0');
        }
    ...
    public function setDecimals(float $decimals) {
        if (($decimals > 5)) {
            throw new IAE('TronCreateTrc10Request.setDecimals: $decimals must be <=5');
        }
        if (($decimals < 0)) {
            throw new IAE('TronCreateTrc10Request.setDecimals: $decimals must be >=0');
        }
    ...
    public function setFrom(string $from) {
        if ((mb_strlen($from) > 34)) {
            throw new IAE('TronCreateTrc10Request.setFrom: $from length must be <= 34');
        }
        if ((mb_strlen($from) < 34)) {
            throw new IAE('TronCreateTrc10Request.setFrom: $from length must be >= 34');
        }
    ...
    public function setIndex(?float $index) {
        if (!is_null($index) && ($index < 0)) {
            throw new IAE('TronCreateTrc10Request.setIndex: $index must be >=0');
        }
