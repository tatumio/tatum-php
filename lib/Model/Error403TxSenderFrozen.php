 ...
 * Error403TxSenderFrozen Model
 */
class Error403TxSenderFrozen extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403TxSenderFrozen";
     ...
     * Set error_code
     * 
     * @param string $error_code senderAccount.frozen
     ...
     * Set message
     * 
     * @param string $message Sender account ${transaction.senderAccountId} is frozen, unable to perform payment.
     * @throws \InvalidArgumentException
     * @return $this
     */
