...
/**
 * CancelOrSettleAuctionCeloKMS Model
 *
 * @version   3.17.0
 ...
 * CancelOrSettleAuctionCeloKMS Model
 */
class CancelOrSettleAuctionCeloKMS extends AbstractModel {
    ...
    protected static $_name = "CancelOrSettleAuctionCeloKMS";
    ...
    public function __construct(array $data = []) {
        foreach(["chain"=>null, "fee_currency"=>null, "contract_address"=>null, "erc20_address"=>null, "id"=>null, "signature_id"=>null, "index"=>null, "nonce"=>null, "fee"=>null] as $k => $v) {
    ...
    public function setChain(string $chain) {
        ...
        if (!in_array($chain, $allowed, true)) {
            throw new IAE(sprintf("CancelOrSettleAuctionCeloKMS.setChain: chain invalid value '%s', must be one of '%s'", $chain, implode("', '", $allowed)));
        }
    ...
    public function setFeeCurrency(string $fee_currency) {
        ...
        if (!in_array($fee_currency, $allowed, true)) {
            throw new IAE(sprintf("CancelOrSettleAuctionCeloKMS.setFeeCurrency: fee_currency invalid value '%s', must be one of '%s'", $fee_currency, implode("', '", $allowed)));
        }
    ...
    public function setContractAddress(string $contract_address) {
        if ((mb_strlen($contract_address) > 42)) {
            throw new IAE('CancelOrSettleAuctionCeloKMS.setContractAddress: $contract_address length must be <= 42');
        }
        if ((mb_strlen($contract_address) < 42)) {
            throw new IAE('CancelOrSettleAuctionCeloKMS.setContractAddress: $contract_address length must be >= 42');
        }
    ...
    public function setErc20Address(?string $erc20_address) {
        if (!is_null($erc20_address) && (mb_strlen($erc20_address) > 42)) {
            throw new IAE('CancelOrSettleAuctionCeloKMS.setErc20Address: $erc20_address length must be <= 42');
        }
        if (!is_null($erc20_address) && (mb_strlen($erc20_address) < 42)) {
            throw new IAE('CancelOrSettleAuctionCeloKMS.setErc20Address: $erc20_address length must be >= 42');
        }
    ...
    public function setId(string $id) {
        if ((mb_strlen($id) > 200)) {
            throw new IAE('CancelOrSettleAuctionCeloKMS.setId: $id length must be <= 200');
        }
        if ((mb_strlen($id) < 1)) {
            throw new IAE('CancelOrSettleAuctionCeloKMS.setId: $id length must be >= 1');
        }
        $this->_data['id'] = $id;
    ...
    public function setIndex(?float $index) {
        if (!is_null($index) && ($index < 0)) {
            throw new IAE('CancelOrSettleAuctionCeloKMS.setIndex: $index must be >=0');
        }
