 ...
 * Error403XrpFailed Model
 */
class Error403XrpFailed extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403XrpFailed";
     ...
     * Set error_code
     * 
     * @param string $error_code xrp.failed
     ...
     * Set message
     * 
     * @param string $message Unable to communicate with blockchain. ${error}
     * @throws \InvalidArgumentException
     * @return $this
     */
