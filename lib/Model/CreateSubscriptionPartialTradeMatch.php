...
class CreateSubscriptionPartialTradeMatch extends AbstractModel {
    ...
    protected static $_definition = [
        ...
        "attr" => ["attr", "\Tatum\Model\CreateSubscriptionPartialTradeMatchAttr", null, "getAttr", "setAttr", null]
    ];
    ...
    public function setType(string $type) {
        ...
        if (!in_array($type, $allowed, true)) {
            throw new IAE(sprintf("CreateSubscriptionPartialTradeMatch.setType: type invalid value '%s', must be one of '%s'", $type, implode("', '", $allowed)));
        }
