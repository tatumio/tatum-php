...
/**
 * BtcTransactionFromUTXOKMS Model
 *
 ...
 * BtcTransactionFromUTXOKMS Model
 */
class BtcTransactionFromUTXOKMS extends AbstractModel {

    public const DISCRIMINATOR = null;
    protected static $_name = "BtcTransactionFromUTXOKMS";
    protected static $_definition = [
        "from_utxo" => ["fromUTXO", "\Tatum\Model\BtcTransactionFromUTXOKMSSource[]", null, "getFromUtxo", "setFromUtxo", null], 
        "to" => ["to", "\Tatum\Model\BtcTransactionFromUTXOKMSTarget[]", null, "getTo", "setTo", null], 
