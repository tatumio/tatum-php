 ...
 * Error403XrpFee Model
 */
class Error403XrpFee extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403XrpFee";
     ...
     * Set error_code
     * 
     * @param string $error_code xrp.fee
     ...
     * Set message
     * 
     * @param string $message Unable to calculate fee.
     * @throws \InvalidArgumentException
     * @return $this
     */
