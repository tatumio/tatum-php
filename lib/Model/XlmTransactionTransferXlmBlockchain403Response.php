...
/**
 * xlmTransactionTransferXlmBlockchain_403_response Model
 *
 ...
 * xlmTransactionTransferXlmBlockchain_403_response Model
 */
class XlmTransactionTransferXlmBlockchain403Response extends AbstractModel {

    public const _D = null;
    protected static $_name = "xlmTransactionTransferXlmBlockchain_403_response";
     ...
     * Set error_code
     * 
     * @param string $error_code xlm.tx.failed
     ...
     * Set message
     * 
     * @param string $message Unable to construct transaction. ${error}
     * @throws \InvalidArgumentException
     * @return $this
     */
