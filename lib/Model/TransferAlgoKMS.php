...
class TransferAlgoKMS extends AbstractModel {
    ...
    public function __construct(array $data = []) {
        foreach(["sender_account_id"=>null, "account"=>null, "address"=>null, "amount"=>null, "fee"=>null, "signature_id"=>null, "index"=>null, "compliant"=>null, "payment_id"=>null, "sender_note"=>null] as $k => $v) {
    ...
    public function setAccount(string $account) {
        if ((mb_strlen($account) > 58)) {
            throw new IAE('TransferAlgoKMS.setAccount: $account length must be <= 58');
        }
        if ((mb_strlen($account) < 58)) {
            throw new IAE('TransferAlgoKMS.setAccount: $account length must be >= 58');
        }
