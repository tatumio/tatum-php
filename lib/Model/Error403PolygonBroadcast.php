...
/**
 * Error403PolygonBroadcast Model
 *
 ...
 * Error403PolygonBroadcast Model
 */
class Error403PolygonBroadcast extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403PolygonBroadcast";
     ...
     * Set error_code
     * 
     * @param string $error_code polygon.broadcast.failed
     ...
     * Set message
     * 
     * @param string $message Unable to broadcast transaction due to ${error}.
     * @throws \InvalidArgumentException
     * @return $this
     */
