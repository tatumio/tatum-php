...
class LtcTxInputsInner extends AbstractModel {
    ...
    protected static $_definition = [
        "prevout" => ["prevout", "\Tatum\Model\LtcTxInputsInnerPrevout", null, "getPrevout", "setPrevout", null], 
        "script" => ["script", "string", null, "getScript", "setScript", null], 
        "witness" => ["witness", "string", null, "getWitness", "setWitness", null], 
        "sequence" => ["sequence", "float", null, "getSequence", "setSequence", null], 
        "coin" => ["coin", "\Tatum\Model\LtcTxInputsInnerCoin", null, "getCoin", "setCoin", null]
    ];
