...
/**
 * broadcastBlockchainTransaction_403_response Model
 *
 ...
 * broadcastBlockchainTransaction_403_response Model
 */
class BroadcastBlockchainTransaction403Response extends AbstractModel {

    public const _D = null;
    protected static $_name = "broadcastBlockchainTransaction_403_response";
     ...
     * Set error_code
     * 
     * @param string $error_code withdrawal.unexpected.state
     ...
     * Set message
     * 
     * @param string $message Unable to complete withdrawal, which is not in InProgress state.
     * @throws \InvalidArgumentException
     * @return $this
     */
