...
class DeployCeloErc20OffchainMnemonicAddress extends AbstractModel {
    ...
    public function __construct(array $data = []) {
        foreach(["symbol"=>null, "supply"=>null, "description"=>null, "base_pair"=>null, "base_rate"=>1, "customer"=>null, "address"=>null, "mnemonic"=>null, "index"=>null, "nonce"=>null, "fee_currency"=>null] as $k => $v) {
