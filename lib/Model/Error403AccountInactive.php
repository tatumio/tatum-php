 ...
 * Error403AccountInactive Model
 */
class Error403AccountInactive extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403AccountInactive";
     ...
     * Set error_code
     * 
     * @param string $error_code account.inactive
     ...
     * Set message
     * 
     * @param string $message Unable to deactivate inactive account.
     * @throws \InvalidArgumentException
     * @return $this
     */
