...
class TradeAttr extends AbstractModel {
    ...
    protected static $_definition = [
        ...
        "percent_block" => ["percentBlock", "float", null, "getPercentBlock", "setPercentBlock", null], 
        "percent_penalty" => ["percentPenalty", "float", null, "getPercentPenalty", "setPercentPenalty", null]
    ];
