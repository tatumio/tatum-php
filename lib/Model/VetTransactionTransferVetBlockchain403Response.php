...
/**
 * vetTransactionTransferVetBlockchain_403_response Model
 *
 ...
 * vetTransactionTransferVetBlockchain_403_response Model
 */
class VetTransactionTransferVetBlockchain403Response extends AbstractModel {

    public const _D = null;
    protected static $_name = "vetTransactionTransferVetBlockchain_403_response";
     ...
     * Set error_code
     * 
     * @param string $error_code vet.transaction.hash
     ...
     * Set message
     * 
     * @param string $message Unable to calculate transaction hash.
     * @throws \InvalidArgumentException
     * @return $this
     */
