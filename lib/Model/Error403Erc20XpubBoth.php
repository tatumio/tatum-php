 ...
 * Error403Erc20XpubBoth Model
 */
class Error403Erc20XpubBoth extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403Erc20XpubBoth";
     ...
     * Set error_code
     * 
     * @param string $error_code erc20.address.xpub.both
     ...
     * Set message
     * 
     * @param string $message Either xpub or address must be present, not both.
     * @throws \InvalidArgumentException
     * @return $this
     */
