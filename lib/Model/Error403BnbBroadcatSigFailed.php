...
/**
 * Error403BnbBroadcatSigFailed Model
 *
 ...
 * Error403BnbBroadcatSigFailed Model
 */
class Error403BnbBroadcatSigFailed extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403BnbBroadcatSigFailed";
     ...
     * Set error_code
     * 
     * @param string $error_code bnb.broadcast.bad.signature
     ...
     * Set message
     * 
     * @param string $message Unable to broadcast BNB transaction, bad signature.
     * @throws \InvalidArgumentException
     * @return $this
     */
