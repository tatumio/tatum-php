...
/**
 * Error403CustomerDeactivateActiveAccounts Model
 *
 ...
 * Error403CustomerDeactivateActiveAccounts Model
 */
class Error403CustomerDeactivateActiveAccounts extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403CustomerDeactivateActiveAccounts";
     ...
     * Set error_code
     * 
     * @param string $error_code customer.deactivate.account.active
     ...
     * Set message
     * 
     * @param string $message Unable to deactivate customer, accounts not deactivated.
     * @throws \InvalidArgumentException
     * @return $this
     */
