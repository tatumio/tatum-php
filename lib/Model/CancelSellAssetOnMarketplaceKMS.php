...
/**
 * CancelSellAssetOnMarketplaceKMS Model
 *
 ...
 * CancelSellAssetOnMarketplaceKMS Model
 */
class CancelSellAssetOnMarketplaceKMS extends AbstractModel {
    ...
    protected static $_name = "CancelSellAssetOnMarketplaceKMS";
    ...
    public function __construct(array $data = []) {
        foreach(["chain"=>null, "contract_address"=>null, "erc20_address"=>null, "listing_id"=>null, "signature_id"=>null, "index"=>null, "nonce"=>null, "fee"=>null] as $k => $v) {
    ...
    public function setChain(string $chain) {
        ...
        if (!in_array($chain, $allowed, true)) {
            throw new IAE(sprintf("CancelSellAssetOnMarketplaceKMS.setChain: chain invalid value '%s', must be one of '%s'", $chain, implode("', '", $allowed)));
        }
    ...
    public function setContractAddress(string $contract_address) {
        if ((mb_strlen($contract_address) > 42)) {
            throw new IAE('CancelSellAssetOnMarketplaceKMS.setContractAddress: $contract_address length must be <= 42');
        }
        if ((mb_strlen($contract_address) < 42)) {
            throw new IAE('CancelSellAssetOnMarketplaceKMS.setContractAddress: $contract_address length must be >= 42');
        }
    ...
    public function setErc20Address(?string $erc20_address) {
        if (!is_null($erc20_address) && (mb_strlen($erc20_address) > 42)) {
            throw new IAE('CancelSellAssetOnMarketplaceKMS.setErc20Address: $erc20_address length must be <= 42');
        }
        if (!is_null($erc20_address) && (mb_strlen($erc20_address) < 42)) {
            throw new IAE('CancelSellAssetOnMarketplaceKMS.setErc20Address: $erc20_address length must be >= 42');
        }
    ...
    public function setListingId(string $listing_id) {
        if ((mb_strlen($listing_id) > 200)) {
            throw new IAE('CancelSellAssetOnMarketplaceKMS.setListingId: $listing_id length must be <= 200');
        }
        if ((mb_strlen($listing_id) < 1)) {
            throw new IAE('CancelSellAssetOnMarketplaceKMS.setListingId: $listing_id length must be >= 1');
        }
    ...
    public function setIndex(?float $index) {
        if (!is_null($index) && ($index < 0)) {
            throw new IAE('CancelSellAssetOnMarketplaceKMS.setIndex: $index must be >=0');
        }
