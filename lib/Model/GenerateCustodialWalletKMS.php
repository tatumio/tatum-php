...
class GenerateCustodialWalletKMS extends AbstractModel {
    ...
    public function __construct(array $data = []) {
        foreach(["chain"=>null, "signature_id"=>null, "index"=>null, "enable_fungible_tokens"=>null, "enable_non_fungible_tokens"=>null, "enable_semi_fungible_tokens"=>null, "enable_batch_transactions"=>null, "fee"=>null, "nonce"=>null] as $k => $v) {
