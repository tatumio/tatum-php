...
class MintNftTron extends AbstractModel {
    ...
    public function __construct(array $data = []) {
        foreach(["chain"=>null, "to"=>null, "contract_address"=>null, "token_id"=>null, "url"=>null, "fee_limit"=>null, "from_private_key"=>null, "author_addresses"=>null, "cashback_values"=>null] as $k => $v) {
