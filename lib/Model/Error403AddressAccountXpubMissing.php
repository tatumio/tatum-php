...
/**
 * Error403AddressAccountXpubMissing Model
 *
 ...
 * Error403AddressAccountXpubMissing Model
 */
class Error403AddressAccountXpubMissing extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403AddressAccountXpubMissing";
     ...
     * Set error_code
     * 
     * @param string $error_code account.xpub.missing
     ...
     * Set message
     * 
     * @param string $message No xpub assigned to account, it is not possible to generate address. Use assignAddress method instead.
     * @throws \InvalidArgumentException
     * @return $this
     */
