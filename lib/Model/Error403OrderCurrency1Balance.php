...
/**
 * Error403OrderCurrency1Balance Model
 *
...
class Error403OrderCurrency1Balance extends AbstractModel {
     ...
     * Set error_code
     * 
     * @param string $error_code trade.currency1.balance
     ...
     * Set message
     * 
     * @param string $message Insufficient balance on currency1 account ${trade.currency1AccountId}.
     * @throws \InvalidArgumentException
     * @return $this
     */
