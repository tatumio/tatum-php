 ...
 * Error401NotActive Model
 */
class Error401NotActive extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error401NotActive";
     ...
     * Set error_code
     * 
     * @param string $error_code subscription.not.active
     ...
     * Set message
     * 
     * @param string $message Subscription not active anymore.
     * @throws \InvalidArgumentException
     * @return $this
     */
