...
/**
 * Error403AccountCurrencyVC Model
 *
 ...
 * Error403AccountCurrencyVC Model
 */
class Error403AccountCurrencyVC extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403AccountCurrencyVC";
     ...
     * Set error_code
     * 
     * @param string $error_code account.currency.missing
     ...
     * Set message
     * 
     * @param string $message No such virtual currency ${currency} for account ${account}.
     * @throws \InvalidArgumentException
     * @return $this
     */
