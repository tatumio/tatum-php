 ...
 * Error403PolygonGasPrice Model
 */
class Error403PolygonGasPrice extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403PolygonGasPrice";
     ...
     * Set error_code
     * 
     * @param string $error_code gas.price.failed
     ...
     * Set message
     * 
     * @param string $message Unable to obtain current GAS price.
     * @throws \InvalidArgumentException
     * @return $this
     */
