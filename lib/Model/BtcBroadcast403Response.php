...
/**
 * BtcBroadcast_403_response Model
 *
 ...
 * BtcBroadcast_403_response Model
 */
class BtcBroadcast403Response extends AbstractModel {

    public const _D = null;
    protected static $_name = "BtcBroadcast_403_response";
     ...
     * Set error_code
     * 
     * @param string $error_code blockchain.broadcast.error
     ...
     * Set message
     * 
     * @param string $message Unable to broadcast transaction, wrong input data.
     * @throws \InvalidArgumentException
     * @return $this
     */
