...
/**
 * TronAccountTx20_200_response Model
 *
 ...
 * TronAccountTx20_200_response Model
 */
class TronAccountTx20200Response extends AbstractModel {

    public const _D = null;
    protected static $_name = "TronAccountTx20_200_response";
    protected static $_definition = [
        "next" => ["next", "string", null, "getNext", "setNext", null, ["r" => 0]], 
        "transactions" => ["transactions", "\Tatum\Model\TronTx20[]", null, "getTransactions", "setTransactions", null, ["r" => 1, "c" => 1]]
    ];
     ...
     * Set transactions
     * 
     * @param \Tatum\Model\TronTx20[] $transactions The list of transactions for the specified TRON account
     * @throws \InvalidArgumentException
     * @return $this
     */
