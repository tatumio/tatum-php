...
class CreateSubscriptionKMSSuccess extends AbstractModel {
    ...
    protected static $_definition = [
        ...
        "attr" => ["attr", "\Tatum\Model\CreateSubscriptionKMSSuccessAttr", null, "getAttr", "setAttr", null]
    ];
    ...
    public function setType(string $type) {
        ...
        if (!in_array($type, $allowed, true)) {
            throw new IAE(sprintf("CreateSubscriptionKMSSuccess.setType: type invalid value '%s', must be one of '%s'", $type, implode("', '", $allowed)));
        }
