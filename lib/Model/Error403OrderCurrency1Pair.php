...
/**
 * Error403OrderCurrency1Pair Model
 *
 ...
 * Error403OrderCurrency1Pair Model
 */
class Error403OrderCurrency1Pair extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403OrderCurrency1Pair";
     ...
     * Set error_code
     * 
     * @param string $error_code trade.currency1.pair
     ...
     * Set message
     * 
     * @param string $message Incompatible currencies for currency1 account ${trade.currency1AccountId} and trading pair.
     * @throws \InvalidArgumentException
     * @return $this
     */
