 ...
 * Error403XrpAttr Model
 */
class Error403XrpAttr extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403XrpAttr";
     ...
     * Set error_code
     * 
     * @param string $error_code attr.wrong.format
     ...
     * Set message
     * 
     * @param string $message Wrong attr of withdrawal, should be of uint32 type.
     * @throws \InvalidArgumentException
     * @return $this
     */
