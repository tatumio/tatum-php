...
class SellAssetOnMarketplaceRequest extends AbstractModel {
    ...
    public function __construct(array $data = []) {
        foreach(["chain"=>null, "contract_address"=>null, "nft_address"=>null, "seller"=>null, "erc20_address"=>null, "listing_id"=>null, "amount"=>null, "token_id"=>null, "price"=>null, "is_erc721"=>null, "from_private_key"=>null, "nonce"=>null, "fee"=>null, "signature_id"=>null, "index"=>null, "fee_currency"=>null] as $k => $v) {
    ...
    public function setContractAddress(string $contract_address) {
        if ((mb_strlen($contract_address) > 42)) {
            throw new IAE('SellAssetOnMarketplaceRequest.setContractAddress: $contract_address length must be <= 42');
        }
        if ((mb_strlen($contract_address) < 42)) {
            throw new IAE('SellAssetOnMarketplaceRequest.setContractAddress: $contract_address length must be >= 42');
        }
    ...
    public function setNftAddress(string $nft_address) {
        if ((mb_strlen($nft_address) > 42)) {
            throw new IAE('SellAssetOnMarketplaceRequest.setNftAddress: $nft_address length must be <= 42');
        }
        if ((mb_strlen($nft_address) < 42)) {
            throw new IAE('SellAssetOnMarketplaceRequest.setNftAddress: $nft_address length must be >= 42');
        }
    ...
    public function setFromPrivateKey(string $from_private_key) {
        if ((mb_strlen($from_private_key) > 66)) {
            throw new IAE('SellAssetOnMarketplaceRequest.setFromPrivateKey: $from_private_key length must be <= 66');
        }
        if ((mb_strlen($from_private_key) < 66)) {
            throw new IAE('SellAssetOnMarketplaceRequest.setFromPrivateKey: $from_private_key length must be >= 66');
        }
