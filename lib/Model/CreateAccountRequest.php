...
class CreateAccountRequest extends AbstractModel {
    ...
    public function setXpub(string $xpub) {
        if ((mb_strlen($xpub) > 192)) {
            throw new IAE('CreateAccountRequest.setXpub: $xpub length must be <= 192');
        }
        if ((mb_strlen($xpub) < 1)) {
            throw new IAE('CreateAccountRequest.setXpub: $xpub length must be >= 1');
        }
    ...
    public function setAccountCode(?string $account_code) {
        if (!is_null($account_code) && (mb_strlen($account_code) > 50)) {
            throw new IAE('CreateAccountRequest.setAccountCode: $account_code length must be <= 50');
        }
        if (!is_null($account_code) && (mb_strlen($account_code) < 1)) {
            throw new IAE('CreateAccountRequest.setAccountCode: $account_code length must be >= 1');
        }
    ...
    public function setAccountingCurrency(?string $accounting_currency) {
        ...
        if (!is_null($accounting_currency) && !in_array($accounting_currency, $allowed, true)) {
            throw new IAE(sprintf("CreateAccountRequest.setAccountingCurrency: accounting_currency invalid value '%s', must be one of '%s'", $accounting_currency, implode("', '", $allowed)));
        }
        if (!is_null($accounting_currency) && (mb_strlen($accounting_currency) > 3)) {
            throw new IAE('CreateAccountRequest.setAccountingCurrency: $accounting_currency length must be <= 3');
        }
        if (!is_null($accounting_currency) && (mb_strlen($accounting_currency) < 3)) {
            throw new IAE('CreateAccountRequest.setAccountingCurrency: $accounting_currency length must be >= 3');
        }
    ...
    public function setAccountNumber(?string $account_number) {
        if (!is_null($account_number) && (mb_strlen($account_number) > 50)) {
            throw new IAE('CreateAccountRequest.setAccountNumber: $account_number length must be <= 50');
        }
        if (!is_null($account_number) && (mb_strlen($account_number) < 1)) {
            throw new IAE('CreateAccountRequest.setAccountNumber: $account_number length must be >= 1');
        }
