...
/**
 * Error403AccountIncompatibleXpub Model
 *
 ...
 * Error403AccountIncompatibleXpub Model
 */
class Error403AccountIncompatibleXpub extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403AccountIncompatibleXpub";
     ...
     * Set error_code
     * 
     * @param string $error_code account.xpub.incompatible
     ...
     * Set message
     * 
     * @param string $message Xpub not compatible with account currency.
     * @throws \InvalidArgumentException
     * @return $this
     */
