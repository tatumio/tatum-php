 ...
 * Error403AddressNotFound Model
 */
class Error403AddressNotFound extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403AddressNotFound";
     ...
     * Set error_code
     * 
     * @param string $error_code Address.not.found
     ...
     * Set message
     * 
     * @param string $message No such address exists.
     * @throws \InvalidArgumentException
     * @return $this
     */
