 ...
 * Error403TxAmountAda Model
 */
class Error403TxAmountAda extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403TxAmountAda";
     ...
     * Set error_code
     * 
     * @param string $error_code transaction.amount.ada
     ...
     * Set message
     * 
     * @param string $message ADA payment amount must be at least 0.000001, not ${transaction.amount}.
     * @throws \InvalidArgumentException
     * @return $this
     */
