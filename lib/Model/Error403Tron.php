 ...
 * Error403Tron Model
 */
class Error403Tron extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403Tron";
     ...
     * Set error_code
     * 
     * @param string $error_code tron.failed
     ...
     * Set message
     * 
     * @param string $message Unable to communicate to blockchain. ${error}
     * @throws \InvalidArgumentException
     * @return $this
     */
