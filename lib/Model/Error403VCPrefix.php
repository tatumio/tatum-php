 ...
 * Error403VCPrefix Model
 */
class Error403VCPrefix extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403VCPrefix";
     ...
     * Set error_code
     * 
     * @param string $error_code virtual.name.prefix
     ...
     * Set message
     * 
     * @param string $message Virtual currency has wrong name, must start with VC_.
     * @throws \InvalidArgumentException
     * @return $this
     */
