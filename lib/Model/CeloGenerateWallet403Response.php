...
/**
 * CeloGenerateWallet_403_response Model
 *
 ...
 * CeloGenerateWallet_403_response Model
 */
class CeloGenerateWallet403Response extends AbstractModel {

    public const _D = null;
    protected static $_name = "CeloGenerateWallet_403_response";
     ...
     * Set error_code
     * 
     * @param string $error_code celo.error
     ...
     * Set message
     * 
     * @param string $message Unexpected error occurred. Reason: ${reason}
     * @throws \InvalidArgumentException
     * @return $this
     */
