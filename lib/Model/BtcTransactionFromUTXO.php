...
class BtcTransactionFromUTXO extends AbstractModel {
    ...
    protected static $_definition = [
        "from_utxo" => ["fromUTXO", "\Tatum\Model\BtcTransactionFromUTXOSource[]", null, "getFromUtxo", "setFromUtxo", null], 
        "to" => ["to", "\Tatum\Model\BtcTransactionFromUTXOTarget[]", null, "getTo", "setTo", null], 
