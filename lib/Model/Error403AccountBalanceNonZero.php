...
/**
 * Error403AccountBalanceNonZero Model
 *
 ...
 * Error403AccountBalanceNonZero Model
 */
class Error403AccountBalanceNonZero extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403AccountBalanceNonZero";
     ...
     * Set error_code
     * 
     * @param string $error_code account.balance.non.zero
     ...
     * Set message
     * 
     * @param string $message Unable to deactivate account with non-zero balance.
     * @throws \InvalidArgumentException
     * @return $this
     */
