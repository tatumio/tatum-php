...
/**
 * Error403OrderCurrency1NotFound Model
 *
 ...
 * Error403OrderCurrency1NotFound Model
 */
class Error403OrderCurrency1NotFound extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403OrderCurrency1NotFound";
     ...
     * Set error_code
     * 
     * @param string $error_code trade.currency1AccountId.not.exists
     ...
     * Set message
     * 
     * @param string $message Unable to find currency1 account ${trade.currency1AccountId}.
     * @throws \InvalidArgumentException
     * @return $this
     */
