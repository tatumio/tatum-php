 ...
 * Error403BtcTx Model
 */
class Error403BtcTx extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403BtcTx";
     ...
     * Set error_code
     * 
     * @param string $error_code transaction.invalid.body
     ...
     * Set message
     * 
     * @param string $message Either UTXO, or addresses must be present.
     * @throws \InvalidArgumentException
     * @return $this
     */
