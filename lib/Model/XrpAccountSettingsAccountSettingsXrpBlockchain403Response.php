...
/**
 * xrpAccountSettingsAccountSettingsXrpBlockchain_403_response Model
 *
 ...
 * xrpAccountSettingsAccountSettingsXrpBlockchain_403_response Model
 */
class XrpAccountSettingsAccountSettingsXrpBlockchain403Response extends AbstractModel {

    public const _D = null;
    protected static $_name = "xrpAccountSettingsAccountSettingsXrpBlockchain_403_response";
     ...
     * Set error_code
     * 
     * @param string $error_code xrp.settings.multiple
     ...
     * Set message
     * 
     * @param string $message It is possible to set 1 parameter at a time.
     * @throws \InvalidArgumentException
     * @return $this
     */
