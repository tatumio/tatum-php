...
/**
 * deleteAllBlockAmount_403_response Model
 *
 ...
 * deleteAllBlockAmount_403_response Model
 */
class DeleteAllBlockAmount403Response extends AbstractModel {

    public const _D = null;
    protected static $_name = "deleteAllBlockAmount_403_response";
     ...
     * Set error_code
     * 
     * @param string $error_code customer.blockage.inactive
     ...
     * Set message
     * 
     * @param string $message Unable to delete blockages on account for inactive customer.
     * @throws \InvalidArgumentException
     * @return $this
     */
