...
/**
 * Error403SolanaBroadcastConfirm Model
 *
 ...
 * Error403SolanaBroadcastConfirm Model
 */
class Error403SolanaBroadcastConfirm extends AbstractModel {

    public const _D = null;
    protected static $_name = "Error403SolanaBroadcastConfirm";
     ...
     * Set error_code
     * 
     * @param string $error_code solana.broadcast.confirm.failed
     ...
     * Set message
     * 
     * @param string $message Unexpected error occurred. Reason: ${error}.
     * @throws \InvalidArgumentException
     * @return $this
     */
