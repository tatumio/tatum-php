...
/**
 * NftVerifyInCollection_request Model
 *
 * @version   3.17.1
 ...
 * NftVerifyInCollection_request Model
 */
class NftVerifyInCollectionRequest extends AbstractModel {
    ...
    public function setChain(string $chain) {
        ...
        if (!in_array($chain, $allowed, true)) {
            throw new IAE(sprintf("NftVerifyInCollectionRequest.setChain: chain invalid value '%s', must be one of '%s'", $chain, implode("', '", $allowed)));
        }
    ...
    public function setNftAddress(string $nft_address) {
        if ((mb_strlen($nft_address) > 44)) {
            throw new IAE('NftVerifyInCollectionRequest.setNftAddress: $nft_address length must be <= 44');
        }
        if ((mb_strlen($nft_address) < 43)) {
            throw new IAE('NftVerifyInCollectionRequest.setNftAddress: $nft_address length must be >= 43');
        }
    ...
    public function setCollectionAddress(string $collection_address) {
        if ((mb_strlen($collection_address) > 44)) {
            throw new IAE('NftVerifyInCollectionRequest.setCollectionAddress: $collection_address length must be <= 44');
        }
        if ((mb_strlen($collection_address) < 43)) {
            throw new IAE('NftVerifyInCollectionRequest.setCollectionAddress: $collection_address length must be >= 43');
        }
    ...
    public function setFrom(string $from) {
        if ((mb_strlen($from) > 44)) {
            throw new IAE('NftVerifyInCollectionRequest.setFrom: $from length must be <= 44');
        }
        if ((mb_strlen($from) < 43)) {
            throw new IAE('NftVerifyInCollectionRequest.setFrom: $from length must be >= 43');
        }
    ...
    public function setFromPrivateKey(string $from_private_key) {
        if ((mb_strlen($from_private_key) > 128)) {
            throw new IAE('NftVerifyInCollectionRequest.setFromPrivateKey: $from_private_key length must be <= 128');
        }
        if ((mb_strlen($from_private_key) < 64)) {
            throw new IAE('NftVerifyInCollectionRequest.setFromPrivateKey: $from_private_key length must be >= 64');
        }
