...
use Tatum\Sdk\Psr7\Exception\MalformedUriException;
...
class Uri implements UriInterface, \JsonSerializable {
     ...
     * `Tatum\Sdk\Psr7\Http\UriInterface::__toString`.
     *
     ...
     *
     * `Tatum\Sdk\Psr7\Http\UriInterface::getPort` may return null or the standard port. This method can be used
