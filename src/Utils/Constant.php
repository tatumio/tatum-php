...
class Constant
{
    public const TATUM_API_URL = 'https://api-eu1.tatum.io/v3';

    public const TEST_VET_URL = 'https://sync-testnet.vechain.org/';
    public const VET_URL = 'https://sync-mainnet.vechain.org/';

    public const DERIVATION_PATH = [
        'BTC' => "44'/0'/0'/0",
        'ETH' => "44'/60'/0'/0",
        'VET' => "44'/818'/0'/0",
        'LTC' => "44'/2'/0'/0",
    ...
    public const CONTRACT_DECIMALS = array(
        ['USDT' => 6],
        ['USDT_TRON' => 6],
        ['WBTC' => 8],
        ['LEO' => 18],
    ...
    public const TRANSFER_METHOD_ABI = array(
        ['constant' => false],
        'inputs' => [
            array(
                'name' => 'to',
