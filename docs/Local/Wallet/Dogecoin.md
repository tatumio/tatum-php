...
> 
> [✨ php -f **generateWallet.php**](https://github.com/tatumio/tatum-php/blob/master/examples/Local/Wallet/Dogecoin/generateWallet.php){: .btn .btn-green .mt-4}
...
> #️⃣ Execute command in terminal 
> 
> [✨ php -f **generateAddressFromXpub.php**](https://github.com/tatumio/tatum-php/blob/master/examples/Local/Wallet/Dogecoin/generateAddressFromXpub.php){: .btn .btn-green .mt-4}
...
> #️⃣ Execute command in terminal 
> 
> [✨ php -f **generateAddressFromPrivateKey.php**](https://github.com/tatumio/tatum-php/blob/master/examples/Local/Wallet/Dogecoin/generateAddressFromPrivateKey.php){: .btn .btn-green .mt-4}
...
> #️⃣ Execute command in terminal 
> 
> [✨ php -f **generatePrivateKey.php**](https://github.com/tatumio/tatum-php/blob/master/examples/Local/Wallet/Dogecoin/generatePrivateKey.php){: .btn .btn-green .mt-4}
