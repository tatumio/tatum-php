...
> 
> [✨ php -f **generateWallet.php**](https://github.com/tatumio/tatum-php/blob/master/examples/Local/Wallet/BitcoinCash/generateWallet.php){: .btn .btn-green .mt-4}
...
> #️⃣ Execute command in terminal 
> 
> [✨ php -f **generateAddressFromXpub.php**](https://github.com/tatumio/tatum-php/blob/master/examples/Local/Wallet/BitcoinCash/generateAddressFromXpub.php){: .btn .btn-green .mt-4}
...
> #️⃣ Execute command in terminal 
> 
> [✨ php -f **generateAddressFromPrivateKey.php**](https://github.com/tatumio/tatum-php/blob/master/examples/Local/Wallet/BitcoinCash/generateAddressFromPrivateKey.php){: .btn .btn-green .mt-4}
...
> #️⃣ Execute command in terminal 
> 
> [✨ php -f **generatePrivateKey.php**](https://github.com/tatumio/tatum-php/blob/master/examples/Local/Wallet/BitcoinCash/generatePrivateKey.php){: .btn .btn-green .mt-4}
