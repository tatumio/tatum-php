...
> 
> [✨ php -f **generateWallet.php**](https://github.com/tatumio/tatum-php/blob/master/examples/Local/Wallet/Polygon/generateWallet.php){: .btn .btn-green .mt-4}
...
> #️⃣ Execute command in terminal 
> 
> [✨ php -f **generateAddressFromXpub.php**](https://github.com/tatumio/tatum-php/blob/master/examples/Local/Wallet/Polygon/generateAddressFromXpub.php){: .btn .btn-green .mt-4}
...
> #️⃣ Execute command in terminal 
> 
> [✨ php -f **generateAddressFromPrivateKey.php**](https://github.com/tatumio/tatum-php/blob/master/examples/Local/Wallet/Polygon/generateAddressFromPrivateKey.php){: .btn .btn-green .mt-4}
...
> #️⃣ Execute command in terminal 
> 
> [✨ php -f **generatePrivateKey.php**](https://github.com/tatumio/tatum-php/blob/master/examples/Local/Wallet/Polygon/generatePrivateKey.php){: .btn .btn-green .mt-4}
