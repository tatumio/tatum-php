...
<b>The number of credits consumed depends on the number of methods submitted in an API call:
 ...
 * 2 credits per any other RPC method</b>
...
<b>2 credits per RPC method in an API call</b>
