...
try {
    /** @var \Tatum\Model\BscGenerateAddress200Response $response */
    $response = $sdk
        ->mainnet()
        ->api()
        ->bNBSmartChain()
...
[**\Tatum\Model\BscGenerateAddress200Response**](../Model/BscGenerateAddress200Response.md)
...
try {
    /** @var \Tatum\Model\BscGetBalance200Response $response */
    $response = $sdk
        ->mainnet()
        ->api()
        ->bNBSmartChain()
...
[**\Tatum\Model\BscGetBalance200Response**](../Model/BscGetBalance200Response.md)
