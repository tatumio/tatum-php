...
[**ltcTransferBlockchain()**](#ltctransferblockchain) | **POST** [/v3/litecoin/transaction](https://apidoc.tatum.io/tag/Litecoin#operation/LtcTransferBlockchain) | Send LTC to Litecoin addresses
