...
------------- | ------------- | -------------
[**oneBlockchainSmartContractInvocation()**](#oneblockchainsmartcontractinvocation) | **POST** [/v3/one/smartcontract](https://apidoc.tatum.io/tag/Harmony#operation/OneBlockchainSmartContractInvocation) | Invoke a method in a smart contract on Harmony
[**oneBlockchainTransfer()**](#oneblockchaintransfer) | **POST** [/v3/one/transaction](https://apidoc.tatum.io/tag/Harmony#operation/OneBlockchainTransfer) | Send ONE / HRM20 from account to account
