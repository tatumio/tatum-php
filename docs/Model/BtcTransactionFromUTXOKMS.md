...
------------ | ------------- | ------------- | -------------
**getFromUtxo()** | [**\Tatum\Model\BtcTransactionFromUTXOKMSSource[]**](../BtcTransactionFromUTXOKMSSource) | The array of transaction hashes, indexes of its UTXOs, and the signature IDs of the associated blockchain addresses <br>Example: `null` |
