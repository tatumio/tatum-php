 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     SDK docs: https://github.com/tatumio/tatum-php/tree/master/docs/Local/Wallet/Litecoin.md#generateprivatekey
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "Exception when calling local()->wallet()->litecoin()->generatePrivateKey(): %s\n", 
        $exc->getMessage()
    );
}