 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     SDK docs: https://github.com/tatumio/tatum-php/tree/master/docs/Local/Wallet/VeChain.md#generateprivatekey
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "Exception when calling local()->wallet()->vechain()->generatePrivateKey(): %s\n", 
        $exc->getMessage()
    );
}