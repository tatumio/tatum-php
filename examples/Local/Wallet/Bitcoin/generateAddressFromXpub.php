 ...
 * 
 * @link    https://tatumio.github.io/tatum-php/Local/Wallet/Bitcoin/#generateaddressfromxpub
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "Exception when calling local()->wallet()->bitcoin()->generateAddressFromXpub(): %s\n", 
        $exc->getMessage()
    );
}