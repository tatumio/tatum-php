 ...
 * 
 * @link    https://tatumio.github.io/tatum-php/Local/Wallet/XDC/#generateaddressfromprivatekey
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "Exception when calling local()->wallet()->xdc()->generateAddressFromPrivateKey(): %s\n", 
        $exc->getMessage()
    );
}