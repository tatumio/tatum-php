 ...
 * 
 * @link    https://tatumio.github.io/tatum-php/Local/Wallet/BitcoinCash/#generateprivatekey
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "Exception when calling local()->wallet()->bitcoinCash()->generatePrivateKey(): %s\n", 
        $exc->getMessage()
    );
}