 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Stellar#operation/TransferXlmBlockchainAsset
...
try {
    ...
    echo "API Exception when calling api()->stellar()->transferXlmBlockchainAsset(): ", 
