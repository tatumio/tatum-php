 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Stellar#operation/TransferXlmBlockchainKMSAsset
...
try {
    ...
    echo "API Exception when calling api()->stellar()->transferXlmBlockchainKMSAsset(): ", 
