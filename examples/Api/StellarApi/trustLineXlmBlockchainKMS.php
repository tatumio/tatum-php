 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Stellar#operation/TrustLineXlmBlockchainKMS
...
try {
    ...
    echo "API Exception when calling api()->stellar()->trustLineXlmBlockchainKMS(): ", 
