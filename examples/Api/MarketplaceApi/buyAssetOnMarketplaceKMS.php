 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Marketplace#operation/BuyAssetOnMarketplaceKMS
...
try {
    ...
    echo "API Exception when calling api()->marketplace()->buyAssetOnMarketplaceKMS(): ", 
