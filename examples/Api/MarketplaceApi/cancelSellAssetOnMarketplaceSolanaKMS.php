 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Marketplace#operation/CancelSellAssetOnMarketplaceSolanaKMS
...
try {
    ...
    echo "API Exception when calling api()->marketplace()->cancelSellAssetOnMarketplaceSolanaKMS(): ", 
