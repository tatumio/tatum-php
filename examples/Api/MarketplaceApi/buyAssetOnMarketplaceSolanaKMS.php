 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Marketplace#operation/BuyAssetOnMarketplaceSolanaKMS
...
try {
    ...
    echo "API Exception when calling api()->marketplace()->buyAssetOnMarketplaceSolanaKMS(): ", 
