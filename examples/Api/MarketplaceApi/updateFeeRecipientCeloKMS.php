 ...
 * 
 * @link    https://tatumio.github.io/tatum-php/Api/MarketplaceApi/#updatefeerecipientcelokms
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->marketplace()->updateFeeRecipientCeloKMS(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->marketplace()->updateFeeRecipientCeloKMS(): %s\n", 
        $exc->getMessage()
    );
}