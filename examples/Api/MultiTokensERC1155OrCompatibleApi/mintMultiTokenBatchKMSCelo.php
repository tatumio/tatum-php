 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/MultiTokensERC1155OrCompatible#operation/MintMultiTokenBatchKMSCelo
...
try {
    ...
    echo "API Exception when calling api()->multiTokensERC1155OrCompatible()->mintMultiTokenBatchKMSCelo(): ", 
