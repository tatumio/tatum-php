 ...
 * 
 * @link    https://tatumio.github.io/tatum-php/Api/VeChainApi/#vetbroadcast
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->veChain()->vetBroadcast(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->veChain()->vetBroadcast(): %s\n", 
        $exc->getMessage()
    );
}