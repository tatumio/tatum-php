 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/FungibleTokensERC20OrCompatible#operation/ApproveCeloErc20KMS
...
try {
    ...
    echo "API Exception when calling api()->fungibleTokensERC20OrCompatible()->approveCeloErc20KMS(): ", 
