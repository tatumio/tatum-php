 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/FungibleTokensERC20OrCompatible#operation/ChainTransferSolanaSpl
...
try {
    ...
    echo "API Exception when calling api()->fungibleTokensERC20OrCompatible()->chainTransferSolanaSpl(): ", 
