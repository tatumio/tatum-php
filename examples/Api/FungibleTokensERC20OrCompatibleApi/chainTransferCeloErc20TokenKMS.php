 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/FungibleTokensERC20OrCompatible#operation/ChainTransferCeloErc20TokenKMS
...
try {
    ...
    echo "API Exception when calling api()->fungibleTokensERC20OrCompatible()->chainTransferCeloErc20TokenKMS(): ", 
