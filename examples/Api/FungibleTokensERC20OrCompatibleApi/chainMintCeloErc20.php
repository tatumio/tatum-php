 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/FungibleTokensERC20OrCompatible#operation/ChainMintCeloErc20
...
try {
    ...
    echo "API Exception when calling api()->fungibleTokensERC20OrCompatible()->chainMintCeloErc20(): ", 
