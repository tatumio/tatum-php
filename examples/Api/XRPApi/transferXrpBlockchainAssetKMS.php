 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/XRP#operation/TransferXrpBlockchainAssetKMS
...
try {
    ...
    echo "API Exception when calling api()->xRP()->transferXrpBlockchainAssetKMS(): ", 
