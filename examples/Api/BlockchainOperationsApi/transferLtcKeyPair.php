 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/BlockchainOperations#operation/TransferLtcKeyPair
...
try {
    ...
    echo "API Exception when calling api()->blockchainOperations()->transferLtcKeyPair(): ", 
