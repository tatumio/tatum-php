 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/BlockchainOperations#operation/TransferBchKeyPair
...
try {
    ...
    echo "API Exception when calling api()->blockchainOperations()->transferBchKeyPair(): ", 
