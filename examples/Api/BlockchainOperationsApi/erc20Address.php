 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/BlockchainOperations#operation/Erc20Address
...
try {
    ...
    echo "API Exception when calling api()->blockchainOperations()->erc20Address(): ", 
