 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/BlockchainOperations#operation/DeployKCSErc20OffchainMnemonicAddress
...
try {
    ...
    echo "API Exception when calling api()->blockchainOperations()->deployKCSErc20OffchainMnemonicAddress(): ", 
        var_export($apiExc->getResponseObject(), true), 
        PHP_EOL;
} catch (\Exception $exc) {
    echo "Exception when calling api()->blockchainOperations()->deployKCSErc20OffchainMnemonicAddress(): " . $exc->getMessage() . PHP_EOL;
}