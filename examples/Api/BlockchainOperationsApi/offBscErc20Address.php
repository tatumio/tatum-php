 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/BlockchainOperations#operation/OffBscErc20Address
...
try {
    ...
    echo "API Exception when calling api()->blockchainOperations()->offBscErc20Address(): ", 
