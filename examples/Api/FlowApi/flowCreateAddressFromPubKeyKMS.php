 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Flow#operation/FlowCreateAddressFromPubKeyKMS
...
try {
    ...
    echo "API Exception when calling api()->flow()->flowCreateAddressFromPubKeyKMS(): ", 
