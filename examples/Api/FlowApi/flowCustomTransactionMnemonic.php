 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Flow#operation/FlowCustomTransactionMnemonic
...
try {
    ...
    echo "API Exception when calling api()->flow()->flowCustomTransactionMnemonic(): ", 
