 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Flow#operation/FlowTransactionMnemonic
...
try {
    ...
    echo "API Exception when calling api()->flow()->flowTransactionMnemonic(): ", 
        var_export($apiExc->getResponseObject(), true), 
        PHP_EOL;
} catch (\Exception $exc) {
    echo "Exception when calling api()->flow()->flowTransactionMnemonic(): " . $exc->getMessage() . PHP_EOL;
}