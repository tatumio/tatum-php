 ...
 * 
 * @link    https://tatumio.github.io/tatum-php/Api/EthereumApi/#callsmartcontractmethod
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->ethereum()->callSmartContractMethod(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->ethereum()->callSmartContractMethod(): %s\n", 
        $exc->getMessage()
    );
}