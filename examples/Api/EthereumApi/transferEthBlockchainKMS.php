 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Ethereum#operation/TransferEthBlockchainKMS
...
try {
    ...
    echo "API Exception when calling api()->ethereum()->transferEthBlockchainKMS(): ", 
