 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Cardano#operation/AdaTransactionFromUTXOKMS
...
try {
    ...
    echo "API Exception when calling api()->cardano()->adaTransactionFromUTXOKMS(): ", 
