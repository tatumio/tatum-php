 ...
 * 
 * @link    https://tatumio.github.io/tatum-php/Api/LitecoinApi/#ltcbroadcast
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->litecoin()->ltcBroadcast(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->litecoin()->ltcBroadcast(): %s\n", 
        $exc->getMessage()
    );
}