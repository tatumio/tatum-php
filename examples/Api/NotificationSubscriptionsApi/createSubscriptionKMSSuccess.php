 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/NotificationSubscriptions#operation/CreateSubscriptionKMSSuccess
...
try {
    ...
    echo "API Exception when calling api()->notificationSubscriptions()->createSubscriptionKMSSuccess(): ", 
