 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Dogecoin#operation/DogeGenerateAddressPrivateKey
...
try {
    ...
    echo "API Exception when calling api()->dogecoin()->dogeGenerateAddressPrivateKey(): ", 
