 ...
 * 
 * @link    https://tatumio.github.io/tatum-php/Api/DogecoinApi/#dogegeneratewallet
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->dogecoin()->dogeGenerateWallet(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->dogecoin()->dogeGenerateWallet(): %s\n", 
        $exc->getMessage()
    );
}