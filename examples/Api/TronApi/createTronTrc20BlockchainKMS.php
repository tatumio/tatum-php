 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Tron#operation/CreateTronTrc20BlockchainKMS
...
try {
    ...
    echo "API Exception when calling api()->tron()->createTronTrc20BlockchainKMS(): ", 
