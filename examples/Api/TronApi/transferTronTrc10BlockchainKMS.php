 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Tron#operation/TransferTronTrc10BlockchainKMS
...
try {
    ...
    echo "API Exception when calling api()->tron()->transferTronTrc10BlockchainKMS(): ", 
