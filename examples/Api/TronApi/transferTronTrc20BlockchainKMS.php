 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Tron#operation/TransferTronTrc20BlockchainKMS
...
try {
    ...
    echo "API Exception when calling api()->tron()->transferTronTrc20BlockchainKMS(): ", 
