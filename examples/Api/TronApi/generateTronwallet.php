 ...
 * 
 * @link    https://tatumio.github.io/tatum-php/Api/TronApi/#generatetronwallet
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->tron()->generateTronwallet(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->tron()->generateTronwallet(): %s\n", 
        $exc->getMessage()
    );
}