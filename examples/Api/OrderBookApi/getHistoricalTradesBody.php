 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/OrderBook#operation/getHistoricalTradesBody
...
try {
    ...
    echo "API Exception when calling api()->orderBook()->getHistoricalTradesBody(): ", 
