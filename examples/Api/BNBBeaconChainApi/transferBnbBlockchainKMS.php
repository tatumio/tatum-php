 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/BNBBeaconChain#operation/TransferBnbBlockchainKMS
...
try {
    ...
    echo "API Exception when calling api()->bNBBeaconChain()->transferBnbBlockchainKMS(): ", 
