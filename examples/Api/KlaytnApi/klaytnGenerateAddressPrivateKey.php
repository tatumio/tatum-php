 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Klaytn#operation/KlaytnGenerateAddressPrivateKey
...
try {
    ...
    echo "API Exception when calling api()->klaytn()->klaytnGenerateAddressPrivateKey(): ", 
