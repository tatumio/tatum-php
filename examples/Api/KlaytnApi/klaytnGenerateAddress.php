 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Klaytn#operation/KlaytnGenerateAddress
...
try {
    ...
    echo "API Exception when calling api()->klaytn()->klaytnGenerateAddress(): ", 
        var_export($apiExc->getResponseObject(), true), 
        PHP_EOL;
} catch (\Exception $exc) {
    echo "Exception when calling api()->klaytn()->klaytnGenerateAddress(): " . $exc->getMessage() . PHP_EOL;
}