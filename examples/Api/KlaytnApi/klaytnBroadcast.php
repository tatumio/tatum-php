 ...
 * 
 * @link    https://tatumio.github.io/tatum-php/Api/KlaytnApi/#klaytnbroadcast
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->klaytn()->klaytnBroadcast(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->klaytn()->klaytnBroadcast(): %s\n", 
        $exc->getMessage()
    );
}