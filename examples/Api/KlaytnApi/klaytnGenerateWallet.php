 ...
 * 
 * @link    https://tatumio.github.io/tatum-php/Api/KlaytnApi/#klaytngeneratewallet
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->klaytn()->klaytnGenerateWallet(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->klaytn()->klaytnGenerateWallet(): %s\n", 
        $exc->getMessage()
    );
}