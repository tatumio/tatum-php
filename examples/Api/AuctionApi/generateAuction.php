 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Auction#operation/GenerateAuction
...
$arg_generate_auction_request = new \Tatum\Model\GenerateAuctionRequest();
...
try {
    ...
    $response = $sdk
        ...
        ->api()
        ->auction()
        ->generateAuction($arg_generate_auction_request);
