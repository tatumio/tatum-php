 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Auction#operation/SettleAuction
...
$arg_settle_auction_request = new \Tatum\Model\SettleAuctionRequest();
...
try {
    ...
    $response = $sdk
        ...
        ->api()
        ->auction()
        ->settleAuction($arg_settle_auction_request);
