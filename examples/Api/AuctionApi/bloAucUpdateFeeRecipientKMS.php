 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Auction#operation/BloAucUpdateFeeRecipientKMS
...
try {
    ...
    echo "API Exception when calling api()->auction()->bloAucUpdateFeeRecipientKMS(): ", 
