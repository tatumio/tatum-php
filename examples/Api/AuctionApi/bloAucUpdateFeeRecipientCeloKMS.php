 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Auction#operation/BloAucUpdateFeeRecipientCeloKMS
...
try {
    ...
    echo "API Exception when calling api()->auction()->bloAucUpdateFeeRecipientCeloKMS(): ", 
