 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Auction#operation/ApproveNftSpendingCeloKMS
...
try {
    ...
    echo "API Exception when calling api()->auction()->approveNftSpendingCeloKMS(): ", 
