 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/GasPump#operation/GenerateCustodialWalletTron
...
try {
    ...
    echo "API Exception when calling api()->gasPump()->generateCustodialWalletTron(): ", 
