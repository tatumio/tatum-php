 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/GasPump#operation/GenerateCustodialWalletTronKMS
...
try {
    ...
    echo "API Exception when calling api()->gasPump()->generateCustodialWalletTronKMS(): ", 
        var_export($apiExc->getResponseObject(), true), 
        PHP_EOL;
} catch (\Exception $exc) {
    echo "Exception when calling api()->gasPump()->generateCustodialWalletTronKMS(): " . $exc->getMessage() . PHP_EOL;
}