 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Bitcoin#operation/BtcTransactionFromAddress
...
try {
    ...
    echo "API Exception when calling api()->bitcoin()->btcTransactionFromAddress(): ", 
