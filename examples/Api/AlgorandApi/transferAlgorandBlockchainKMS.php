 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Algorand#operation/TransferAlgorandBlockchainKMS
...
try {
    ...
    echo "API Exception when calling api()->algorand()->transferAlgorandBlockchainKMS(): ", 
