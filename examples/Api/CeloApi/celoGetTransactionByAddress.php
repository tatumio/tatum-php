 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Celo#operation/CeloGetTransactionByAddress
 * @see     SDK docs: https://github.com/tatumio/tatum-php/tree/master/docs/Api/CeloApi.md#celogettransactionbyaddress
 * 
 * SECURITY WARNING
...
try {
    ...
    echo "API Exception when calling api()->celo()->celoGetTransactionByAddress(): ", 
