 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Celo#operation/CallCeloSmartContractMethodKMS
...
try {
    ...
    echo "API Exception when calling api()->celo()->callCeloSmartContractMethodKMS(): ", 
