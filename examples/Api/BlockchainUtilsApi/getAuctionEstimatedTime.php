 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/BlockchainUtils#operation/GetAuctionEstimatedTime
...
try {
    ...
    echo "API Exception when calling api()->blockchainUtils()->getAuctionEstimatedTime(): ", 
