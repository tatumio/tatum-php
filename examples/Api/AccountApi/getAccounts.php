 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Account#operation/getAccounts
 * @see     SDK docs: https://github.com/tatumio/tatum-php/tree/master/docs/Api/AccountApi.md#getaccounts
 * 
 * SECURITY WARNING
...
try {
    ...
    echo "API Exception when calling api()->account()->getAccounts(): ", 
        var_export($apiExc->getResponseObject(), true), 
        PHP_EOL;
} catch (\Exception $exc) {
    echo "Exception when calling api()->account()->getAccounts(): " . $exc->getMessage() . PHP_EOL;
}