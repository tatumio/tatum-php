 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/NFTERC721OrCompatible#operation/TransferNftTron
...
try {
    ...
    echo "API Exception when calling api()->nFTERC721OrCompatible()->transferNftTron(): ", 
