 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/NFTERC721OrCompatible#operation/MintMultipleNftKMSCelo
...
try {
    ...
    echo "API Exception when calling api()->nFTERC721OrCompatible()->mintMultipleNftKMSCelo(): ", 
