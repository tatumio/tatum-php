 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Polygon#operation/CallPolygonSmartContractMethodCaller
...
try {
    ...
    echo "API Exception when calling api()->polygon()->callPolygonSmartContractMethodCaller(): ", 
