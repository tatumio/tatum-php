 ...
 * 
 * @link    https://tatumio.github.io/tatum-php/Api/BNBSmartChainApi/#bscbroadcast
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->bNBSmartChain()->bscBroadcast(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->bNBSmartChain()->bscBroadcast(): %s\n", 
        $exc->getMessage()
    );
}