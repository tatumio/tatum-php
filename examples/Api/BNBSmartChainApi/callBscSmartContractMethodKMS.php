 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/BNBSmartChain#operation/CallBscSmartContractMethodKMS
...
try {
    ...
    echo "API Exception when calling api()->bNBSmartChain()->callBscSmartContractMethodKMS(): ", 
