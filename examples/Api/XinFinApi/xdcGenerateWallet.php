 ...
 * 
 * @link    https://tatumio.github.io/tatum-php/Api/XinFinApi/#xdcgeneratewallet
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->xinFin()->xdcGenerateWallet(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->xinFin()->xdcGenerateWallet(): %s\n", 
        $exc->getMessage()
    );
}