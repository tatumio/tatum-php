 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/XinFin#operation/CallXdcSmartContractMethodKMS
...
try {
    ...
    echo "API Exception when calling api()->xinFin()->callXdcSmartContractMethodKMS(): ", 
        var_export($apiExc->getResponseObject(), true), 
        PHP_EOL;
} catch (\Exception $exc) {
    echo "Exception when calling api()->xinFin()->callXdcSmartContractMethodKMS(): " . $exc->getMessage() . PHP_EOL;
}