 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/XinFin#operation/CallXdcSmartContractMethod
...
try {
    ...
    echo "API Exception when calling api()->xinFin()->callXdcSmartContractMethod(): ", 
