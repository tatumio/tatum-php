 ...
 * 
 * @link    https://tatumio.github.io/tatum-php/Api/BlockchainFeesApi/#kcsestimategas
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->blockchainFees()->kcsEstimateGas(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->blockchainFees()->kcsEstimateGas(): %s\n", 
        $exc->getMessage()
    );
}