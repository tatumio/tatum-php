 ...
 * 
 * @link    https://tatumio.github.io/tatum-php/Api/HarmonyApi/#onegeneratewallet
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->harmony()->oneGenerateWallet(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->harmony()->oneGenerateWallet(): %s\n", 
        $exc->getMessage()
    );
}