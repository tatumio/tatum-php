 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Harmony#operation/CallOneSmartContractMethodKMS
...
try {
    ...
    echo "API Exception when calling api()->harmony()->callOneSmartContractMethodKMS(): ", 
