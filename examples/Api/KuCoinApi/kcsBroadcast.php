 ...
 * 
 * @link    https://tatumio.github.io/tatum-php/Api/KuCoinApi/#kcsbroadcast
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->kuCoin()->kcsBroadcast(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->kuCoin()->kcsBroadcast(): %s\n", 
        $exc->getMessage()
    );
}