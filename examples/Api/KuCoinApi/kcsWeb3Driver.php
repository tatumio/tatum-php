 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/KuCoin#operation/KcsWeb3Driver
...
try {
    ...
    echo "API Exception when calling api()->kuCoin()->kcsWeb3Driver(): ", 
        var_export($apiExc->getResponseObject(), true), 
        PHP_EOL;
} catch (\Exception $exc) {
    echo "Exception when calling api()->kuCoin()->kcsWeb3Driver(): " . $exc->getMessage() . PHP_EOL;
}