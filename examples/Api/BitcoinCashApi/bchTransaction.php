...
$arg_bch_transaction = (new \Tatum\Model\BchTransaction())
    ...
    // (optional) The fee to be paid for the transaction (in BCH); if you are using this parameter, you have to also use the <code>changeAddress</code> parameter because these two parameters only work together.
    ->setFee('0.0015')
