 ...
 * 
 * @link    https://tatumio.github.io/tatum-php/Api/BitcoinCashApi/#bchgeneratewallet
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->bitcoinCash()->bchGenerateWallet(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->bitcoinCash()->bchGenerateWallet(): %s\n", 
        $exc->getMessage()
    );
}