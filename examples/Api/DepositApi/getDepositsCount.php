 ...
 * 
 * @link    https://tatumio.github.io/tatum-php/Api/DepositApi/#getdepositscount
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->deposit()->getDepositsCount(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->deposit()->getDepositsCount(): %s\n", 
        $exc->getMessage()
    );
}