 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/CustodialManagedWallets#operation/CustodialGetWallet
...
try {
    ...
    echo "API Exception when calling api()->custodialManagedWallets()->custodialGetWallet(): ", 
