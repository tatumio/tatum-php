 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Solana#operation/TransferSolanaBlockchainKMS
...
try {
    ...
    echo "API Exception when calling api()->solana()->transferSolanaBlockchainKMS(): ", 
