 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/KeyManagementSystem#operation/DeletePendingTransactionToSign
...
try {
        ...
        ->api()
        ->keyManagementSystem()
        ->deletePendingTransactionToSign($arg_id, $arg_revert);} catch (\Tatum\Sdk\ApiException $apiExc) {
    echo "API Exception when calling api()->keyManagementSystem()->deletePendingTransactionToSign(): ", 
