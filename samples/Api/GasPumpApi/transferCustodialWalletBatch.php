...
$arg_transfer_custodial_wallet_batch_request = new \Tatum\Model\TransferCustodialWalletBatchRequest();
...
try {
    ...
    $response = $sdk
        ...
        ->api()
        ->gasPump()
        ->transferCustodialWalletBatch($arg_transfer_custodial_wallet_batch_request);
