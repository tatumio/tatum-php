 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/BlockchainAddresses#operation/assignAddress
...
try {
    ...
    echo "API Exception when calling api()->blockchainAddresses()->assignAddress(): ", 
