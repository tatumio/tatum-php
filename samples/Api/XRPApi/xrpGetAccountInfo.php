 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/XRP#operation/XrpGetAccountInfo
...
try {
    ...
    echo "API Exception when calling api()->xRP()->xrpGetAccountInfo(): ", 
        var_export($apiExc->getResponseObject(), true), 
        PHP_EOL;
} catch (\Exception $exc) {
    echo "Exception when calling api()->xRP()->xrpGetAccountInfo(): " . $exc->getMessage() . PHP_EOL;
}