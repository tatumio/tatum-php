 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/Polygon#operation/PolygonGenerateAddress
...
try {
    ...
    echo "API Exception when calling api()->polygon()->polygonGenerateAddress(): ", 
        var_export($apiExc->getResponseObject(), true), 
        PHP_EOL;
} catch (\Exception $exc) {
    echo "Exception when calling api()->polygon()->polygonGenerateAddress(): " . $exc->getMessage() . PHP_EOL;
}