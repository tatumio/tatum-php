 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/MaliciousAddress#operation/CheckMalicousAddress
...
try {
    ...
    echo "API Exception when calling api()->maliciousAddress()->checkMalicousAddress(): ", 
