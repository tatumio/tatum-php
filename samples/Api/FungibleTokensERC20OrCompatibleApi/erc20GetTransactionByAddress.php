 ...
 * @license MIT
 * @author  Mark Jivko
 * @see     API docs: https://apidoc.tatum.io/tag/FungibleTokensERC20OrCompatible#operation/Erc20GetTransactionByAddress
...
try {
    ...
    echo "API Exception when calling api()->fungibleTokensERC20OrCompatible()->erc20GetTransactionByAddress(): ", 
